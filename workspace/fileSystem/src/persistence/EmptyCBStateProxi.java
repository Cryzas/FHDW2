...
public class EmptyCBStateProxi extends ClipBoardStateProxi implements PersistentEmptyCBState{
    
    public EmptyCBStateProxi(long objectId) {
        super(objectId);
    }
    public EmptyCBStateProxi(PersistentInCacheProxi object) {
        super(object);
    }
