...
public class DirectoryICProxi extends ContaineeICProxi implements PersistentDirectory{
    
    public DirectoryICProxi(long objectId) {
        super(objectId);
    }
    public DirectoryICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theDirectoryFacade
            .getDirectory(this.getId());
    }
