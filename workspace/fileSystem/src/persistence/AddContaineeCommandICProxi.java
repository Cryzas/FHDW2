...
public class AddContaineeCommandICProxi extends PersistentInCacheProxi implements PersistentAddContaineeCommand{
    
    public AddContaineeCommandICProxi(long objectId) {
        super(objectId);
    }
    public AddContaineeCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theAddContaineeCommandFacade
            .getAddContaineeCommand(this.getId());
    }
