...
public class ClipBoardICProxi extends PersistentInCacheProxiOptimistic implements PersistentClipBoard{
    
    public ClipBoardICProxi(long objectId) {
        super(objectId);
    }
    public ClipBoardICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theClipBoardFacade
            .getClipBoard(this.getId());
    }
