...
/* ********************* Cache report ********************** */	
	...
	private void initializeNumber2NameMap() {
		...
		this.number2NameMap.put(120, "AddContaineeCommand");
		this.number2NameMap.put(121, "ChangeContentsCommand");
		this.number2NameMap.put(130, "ClipBoard");
		...
		this.number2NameMap.put(125, "DeleteCommand");
		this.number2NameMap.put(117, "Directory");
		this.number2NameMap.put(129, "EmptyCBState");
		this.number2NameMap.put(-103, "ErrorDisplay");
		this.number2NameMap.put(116, "File");
		this.number2NameMap.put(114, "FileSystem");
		this.number2NameMap.put(128, "FilledCBState");
