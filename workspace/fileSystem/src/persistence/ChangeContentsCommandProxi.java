...
public class ChangeContentsCommandProxi extends PersistentProxi implements PersistentChangeContentsCommand{
    
    public ChangeContentsCommandProxi(long objectId) {
        super(objectId);
    }
    public ChangeContentsCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
