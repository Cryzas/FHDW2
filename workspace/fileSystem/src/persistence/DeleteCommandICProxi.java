...
public class DeleteCommandICProxi extends PersistentInCacheProxi implements PersistentDeleteCommand{
    
    public DeleteCommandICProxi(long objectId) {
        super(objectId);
    }
    public DeleteCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theDeleteCommandFacade
            .getDeleteCommand(this.getId());
    }
