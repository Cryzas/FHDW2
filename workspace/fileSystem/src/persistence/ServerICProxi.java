...
public class ServerICProxi extends PersistentInCacheProxiOptimistic implements PersistentServer{
    ...
    public FileSystem4Public getSystemRoot() 
        ...
        return ((PersistentServer)this.getTheObject()).getSystemRoot();
    }
    ...
    public void changeContents(final File4Public file, final String contents) 
				throws PersistenceException{
        ((PersistentServer)this.getTheObject()).changeContents(file, contents);
    }
    public void clip(final Containee4Public containee) 
				throws PersistenceException{
        ((PersistentServer)this.getTheObject()).clip(containee);
    }
    ...
    public void create(final Directory4Public container, final String name, final String type) 
				throws PersistenceException{
        ((PersistentServer)this.getTheObject()).create(container, name, type);
    }
    public void delete(final Containee4Public containee) 
				throws PersistenceException{
        ((PersistentServer)this.getTheObject()).delete(containee);
    }
    ...
    public FileSystem4Public getSystemRoot(final TDObserver observer) 
				throws PersistenceException{
        return ((PersistentServer)this.getTheObject()).getSystemRoot(observer);
    }
    ...
    public void paste(final Directory4Public directory) 
        ...
        ((PersistentServer)this.getTheObject()).paste(directory);
    }
