...
public abstract class ContaineeProxi extends PersistentProxi implements PersistentContainee{
    
    public ContaineeProxi(long objectId) {
        super(objectId);
    }
    public ContaineeProxi(PersistentInCacheProxi object) {
        super(object);
    }
