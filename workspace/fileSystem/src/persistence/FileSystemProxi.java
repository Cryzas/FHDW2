...
public class FileSystemProxi extends PersistentProxi implements PersistentFileSystem{
    
    public FileSystemProxi(long objectId) {
        super(objectId);
    }
    public FileSystemProxi(PersistentInCacheProxi object) {
        super(object);
    }
