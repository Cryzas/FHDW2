...
public class FilledCBStateProxi extends ClipBoardStateProxi implements PersistentFilledCBState{
    
    public FilledCBStateProxi(long objectId) {
        super(objectId);
    }
    public FilledCBStateProxi(PersistentInCacheProxi object) {
        super(object);
    }
