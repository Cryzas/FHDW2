...
class DetailPanelFactory implements AnythingVisitor {
    ...
    public void handleFilledCBState(view.FilledCBStateView object){
        result = new FilledCBStateDefaultDetailPanel(handler, object);
    }
    public void handleFileSystem(view.FileSystemView object){
        result = new FileSystemDefaultDetailPanel(handler, object);
    }
    public void handleEmptyCBState(view.EmptyCBStateView object){
        result = new EmptyCBStateDefaultDetailPanel(handler, object);
    }
    public void handleClipBoard(view.ClipBoardView object){
        result = new ClipBoardDefaultDetailPanel(handler, object);
    }
    public void handleFile(view.FileView object){
        result = new FileDefaultDetailPanel(handler, object);
    }
    public void handleDirectory(view.DirectoryView object){
        result = new DirectoryDefaultDetailPanel(handler, object);
    }
...
class ServerDefaultDetailPanel extends DefaultDetailPanel{
    ...
    protected static final String Server$$systemRoot = "Server$$systemRoot";
...
class FilledCBStateDefaultDetailPanel extends DefaultDetailPanel{
    
    protected static final String FilledCBState$$contents = "FilledCBState$$contents";
    
    protected FilledCBStateDefaultDetailPanel(ExceptionAndEventHandler exceptionHandler, Anything anything) {
        super(exceptionHandler, anything);
    }
    protected void addFields(){
        
    }
    protected view.FilledCBStateView getAnything(){
        return (view.FilledCBStateView)this.anything;
    }
}

class FileSystemDefaultDetailPanel extends DefaultDetailPanel{
    
    protected static final String FileSystem$$systemRoot = "FileSystem$$systemRoot";
    protected static final String FileSystem$$clipBoard = "FileSystem$$clipBoard";
    
    protected FileSystemDefaultDetailPanel(ExceptionAndEventHandler exceptionHandler, Anything anything) {
        super(exceptionHandler, anything);
    }
    protected void addFields(){
        
    }
    protected view.FileSystemView getAnything(){
        return (view.FileSystemView)this.anything;
    }
}

class EmptyCBStateDefaultDetailPanel extends DefaultDetailPanel{
    
    protected EmptyCBStateDefaultDetailPanel(ExceptionAndEventHandler exceptionHandler, Anything anything) {
        super(exceptionHandler, anything);
    }
    protected void addFields(){
        
    }
    protected view.EmptyCBStateView getAnything(){
        return (view.EmptyCBStateView)this.anything;
    }
}

class ClipBoardDefaultDetailPanel extends DefaultDetailPanel{
    
    protected ClipBoardDefaultDetailPanel(ExceptionAndEventHandler exceptionHandler, Anything anything) {
        super(exceptionHandler, anything);
    }
    protected void addFields(){
        
    }
    protected view.ClipBoardView getAnything(){
        return (view.ClipBoardView)this.anything;
    }
}

class FileDefaultDetailPanel extends DefaultDetailPanel{
    
    protected static final String Containee$$name = "Containee$$name";
    protected static final String File$$contents = "File$$contents";
    
    protected FileDefaultDetailPanel(ExceptionAndEventHandler exceptionHandler, Anything anything) {
        super(exceptionHandler, anything);
    }
    protected void addFields(){
        try{
            ...
            this.getScrollablePane().getChildren().add(panel);
            this.panels.put(Containee$$name, panel);
        }catch(ModelException e){
            this.getExceptionAndEventhandler().handleException(e);
        }
        try{
            BaseTypePanel panel = new TextPanel(this, "contents", this.getAnything().getContents());
            this.getScrollablePane().getChildren().add(panel);
            this.panels.put(File$$contents, panel);
        }catch(ModelException e){
            this.getExceptionAndEventhandler().handleException(e);
        }
        
    }
    protected view.FileView getAnything(){
        return (view.FileView)this.anything;
    }
}

class DirectoryDefaultDetailPanel extends DefaultDetailPanel{
    
    protected static final String Containee$$name = "Containee$$name";
    protected static final String Directory$$contents = "Directory$$contents";
    
    protected DirectoryDefaultDetailPanel(ExceptionAndEventHandler exceptionHandler, Anything anything) {
        super(exceptionHandler, anything);
    }
    protected void addFields(){
        try{
    ...
    protected view.DirectoryView getAnything(){
        return (view.DirectoryView)this.anything;
    }
}
