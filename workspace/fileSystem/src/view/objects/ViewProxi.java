  ...
  private static ProxiFactory [] getTheProxiFactories(){
	if (proxiFactories == null){
        ...
        proxiFactories[27] = new ProxiFactory(){
            ViewProxi create(long objectId, long classId, ExceptionAndEventHandler connectionKey){
                return new FilledCBStateProxi(objectId, classId, connectionKey);
            }
        };
        proxiFactories[13] = new ProxiFactory(){
            ViewProxi create(long objectId, long classId, ExceptionAndEventHandler connectionKey){
                return new FileSystemProxi(objectId, classId, connectionKey);
            }
        };
        proxiFactories[28] = new ProxiFactory(){
            ViewProxi create(long objectId, long classId, ExceptionAndEventHandler connectionKey){
                return new EmptyCBStateProxi(objectId, classId, connectionKey);
            }
        };
        proxiFactories[29] = new ProxiFactory(){
            ViewProxi create(long objectId, long classId, ExceptionAndEventHandler connectionKey){
                return new ClipBoardProxi(objectId, classId, connectionKey);
            }
        };
        proxiFactories[15] = new ProxiFactory(){
            ViewProxi create(long objectId, long classId, ExceptionAndEventHandler connectionKey){
                return new FileProxi(objectId, classId, connectionKey);
            }
        };
        proxiFactories[16] = new ProxiFactory(){
            ViewProxi create(long objectId, long classId, ExceptionAndEventHandler connectionKey){
                return new DirectoryProxi(objectId, classId, connectionKey);
            }
        };
	}
