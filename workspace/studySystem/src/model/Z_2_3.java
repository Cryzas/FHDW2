...
public class Z_2_3 extends model.GradesInTenth implements PersistentZ_2_3{
    ...
    public Z_2_3 provideCopy() throws PersistenceException{
        Z_2_3 result = this;
        result = new Z_2_3(this.subService, 
                           this.This, 
                           this.getId());
    ...
    public Z_2_3(SubjInterface subService,PersistentGrade This,long id) throws PersistenceException {
    ...
    public common.Fraction toFraction() 
    	...
    	return new Fraction(BigInteger.valueOf(23), BigInteger.valueOf(10));
    }
