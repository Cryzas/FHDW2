...
public class T_2_7 extends model.GradesInThird implements PersistentT_2_7{
    
    private static T_2_74Public theT_2_7 = null;
    public static boolean reset$For$Test = false;
    private static final Object $$lock = new Object();
    public static T_2_74Public getTheT_2_7() throws PersistenceException{
        if (theT_2_7 == null || reset$For$Test){
            if (reset$For$Test) theT_2_7 = null;
            class Initializer implements Runnable {
                ...
                void produceSingleton() {
                    synchronized ($$lock){
                        try {
                            T_2_74Public proxi = null;
                            proxi = ConnectionHandler.getTheConnectionHandler().theT_2_7Facade.getTheT_2_7();
                            theT_2_7 = proxi;
                            if(proxi.getId() < 0) {
                ...
                T_2_74Public getResult() throws PersistenceException{
                    synchronized ($$lock) {
                        if (exception == null && theT_2_7== null) try {$$lock.wait();} catch (InterruptedException e) {}
    ...
    public T_2_7 provideCopy() throws PersistenceException{
        T_2_7 result = this;
        result = new T_2_7(this.subService, 
                           this.This, 
                           this.getId());
    ...
    public T_2_7(SubjInterface subService,PersistentGrade This,long id) throws PersistenceException {
    ...
    public PersistentT_2_7 getThis() throws PersistenceException {
        if(this.This == null){
            PersistentT_2_7 result = (PersistentT_2_7)PersistentProxi.createProxi(this.getId(),this.getClassId());
            result.getTheObject();
            return result;
        }return (PersistentT_2_7)this.This;
    }
    ...
    public void initialize(final Anything This, final java.util.HashMap<String,Object> final$$Fields) 
				throws PersistenceException{
        this.setThis((PersistentT_2_7)This);
