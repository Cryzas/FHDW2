...
public abstract class GradeStandardVisitor implements GradeVisitor {
    ...
    protected abstract void standardHandling(Grade4Public grade) throws PersistenceException;
}
