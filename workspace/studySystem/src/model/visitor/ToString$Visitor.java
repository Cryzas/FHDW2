...
public abstract class ToString$Visitor extends AnythingStandardVisitor{
    ...
    public abstract void handleStudyGroupService(StudyGroupService4Public studyGroupService) throws PersistenceException;
    ...
    public abstract void handleStudentManageService(StudentManageService4Public studentManageService) throws PersistenceException;
    public abstract void handleAdminService(AdminService4Public adminService) throws PersistenceException;
    ...
    public abstract void handleUserManagerService(UserManagerService4Public userManagerService) throws PersistenceException;
    public abstract void handleProgramModuleService(ProgramModuleService4Public programModuleService) throws PersistenceException;
