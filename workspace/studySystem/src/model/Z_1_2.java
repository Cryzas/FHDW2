...
public class Z_1_2 extends model.GradesInTenth implements PersistentZ_1_2{
    ...
    public Z_1_2 provideCopy() throws PersistenceException{
        Z_1_2 result = this;
        result = new Z_1_2(this.subService, 
                           this.This, 
                           this.getId());
    ...
    public Z_1_2(SubjInterface subService,PersistentGrade This,long id) throws PersistenceException {
    ...
    public common.Fraction toFraction() 
    	...
    	return new Fraction(BigInteger.valueOf(12), BigInteger.valueOf(10));
    }
