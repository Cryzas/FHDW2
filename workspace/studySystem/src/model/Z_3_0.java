...
public class Z_3_0 extends model.GradesInTenth implements PersistentZ_3_0{
    
    private static Z_3_04Public theZ_3_0 = null;
    public static boolean reset$For$Test = false;
    private static final Object $$lock = new Object();
    public static Z_3_04Public getTheZ_3_0() throws PersistenceException{
        if (theZ_3_0 == null || reset$For$Test){
            if (reset$For$Test) theZ_3_0 = null;
            class Initializer implements Runnable {
                ...
                void produceSingleton() {
                    synchronized ($$lock){
                        try {
                            Z_3_04Public proxi = null;
                            proxi = ConnectionHandler.getTheConnectionHandler().theZ_3_0Facade.getTheZ_3_0();
                            theZ_3_0 = proxi;
                            if(proxi.getId() < 0) {
                ...
                Z_3_04Public getResult() throws PersistenceException{
                    synchronized ($$lock) {
                        if (exception == null && theZ_3_0== null) try {$$lock.wait();} catch (InterruptedException e) {}
    ...
    public Z_3_0 provideCopy() throws PersistenceException{
        Z_3_0 result = this;
        result = new Z_3_0(this.subService, 
                           this.This, 
                           this.getId());
    ...
    public Z_3_0(SubjInterface subService,PersistentGrade This,long id) throws PersistenceException {
    ...
    public PersistentZ_3_0 getThis() throws PersistenceException {
        if(this.This == null){
            PersistentZ_3_0 result = (PersistentZ_3_0)PersistentProxi.createProxi(this.getId(),this.getClassId());
            result.getTheObject();
            return result;
        }return (PersistentZ_3_0)this.This;
    }
    ...
    public void initialize(final Anything This, final java.util.HashMap<String,Object> final$$Fields) 
				throws PersistenceException{
        this.setThis((PersistentZ_3_0)This);
    ...
    public common.Fraction toFraction() 
    	...
    	return new Fraction(BigInteger.valueOf(30), BigInteger.valueOf(10));
    }
