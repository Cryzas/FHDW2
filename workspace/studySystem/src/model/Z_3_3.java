...
public class Z_3_3 extends model.GradesInTenth implements PersistentZ_3_3{
    
    private static Z_3_34Public theZ_3_3 = null;
    public static boolean reset$For$Test = false;
    private static final Object $$lock = new Object();
    public static Z_3_34Public getTheZ_3_3() throws PersistenceException{
        if (theZ_3_3 == null || reset$For$Test){
            if (reset$For$Test) theZ_3_3 = null;
            class Initializer implements Runnable {
                ...
                void produceSingleton() {
                    synchronized ($$lock){
                        try {
                            Z_3_34Public proxi = null;
                            proxi = ConnectionHandler.getTheConnectionHandler().theZ_3_3Facade.getTheZ_3_3();
                            theZ_3_3 = proxi;
                            if(proxi.getId() < 0) {
                ...
                Z_3_34Public getResult() throws PersistenceException{
                    synchronized ($$lock) {
                        if (exception == null && theZ_3_3== null) try {$$lock.wait();} catch (InterruptedException e) {}
    ...
    public Z_3_3 provideCopy() throws PersistenceException{
        Z_3_3 result = this;
        result = new Z_3_3(this.subService, 
                           this.This, 
                           this.getId());
    ...
    public Z_3_3(SubjInterface subService,PersistentGrade This,long id) throws PersistenceException {
    ...
    public PersistentZ_3_3 getThis() throws PersistenceException {
        if(this.This == null){
            PersistentZ_3_3 result = (PersistentZ_3_3)PersistentProxi.createProxi(this.getId(),this.getClassId());
            result.getTheObject();
            return result;
        }return (PersistentZ_3_3)this.This;
    }
    ...
    public void initialize(final Anything This, final java.util.HashMap<String,Object> final$$Fields) 
				throws PersistenceException{
        this.setThis((PersistentZ_3_3)This);
    ...
    public common.Fraction toFraction() 
    	...
    	return new Fraction(BigInteger.valueOf(33), BigInteger.valueOf(10));
    }
