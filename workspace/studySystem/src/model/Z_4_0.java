...
public class Z_4_0 extends model.GradesInTenth implements PersistentZ_4_0{
    
    private static Z_4_04Public theZ_4_0 = null;
    public static boolean reset$For$Test = false;
    private static final Object $$lock = new Object();
    public static Z_4_04Public getTheZ_4_0() throws PersistenceException{
        if (theZ_4_0 == null || reset$For$Test){
            if (reset$For$Test) theZ_4_0 = null;
            class Initializer implements Runnable {
                ...
                void produceSingleton() {
                    synchronized ($$lock){
                        try {
                            Z_4_04Public proxi = null;
                            proxi = ConnectionHandler.getTheConnectionHandler().theZ_4_0Facade.getTheZ_4_0();
                            theZ_4_0 = proxi;
                            if(proxi.getId() < 0) {
                ...
                Z_4_04Public getResult() throws PersistenceException{
                    synchronized ($$lock) {
                        if (exception == null && theZ_4_0== null) try {$$lock.wait();} catch (InterruptedException e) {}
    ...
    public Z_4_0 provideCopy() throws PersistenceException{
        Z_4_0 result = this;
        result = new Z_4_0(this.subService, 
                           this.This, 
                           this.getId());
    ...
    public Z_4_0(SubjInterface subService,PersistentGrade This,long id) throws PersistenceException {
    ...
    public PersistentZ_4_0 getThis() throws PersistenceException {
        if(this.This == null){
            PersistentZ_4_0 result = (PersistentZ_4_0)PersistentProxi.createProxi(this.getId(),this.getClassId());
            result.getTheObject();
            return result;
        }return (PersistentZ_4_0)this.This;
    }
    ...
    public void initialize(final Anything This, final java.util.HashMap<String,Object> final$$Fields) 
				throws PersistenceException{
        this.setThis((PersistentZ_4_0)This);
    ...
    public common.Fraction toFraction() 
    	...
    	return new Fraction(BigInteger.valueOf(40), BigInteger.valueOf(10));
    }
