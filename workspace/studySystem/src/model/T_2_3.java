...
public class T_2_3 extends model.GradesInThird implements PersistentT_2_3{
    
    private static T_2_34Public theT_2_3 = null;
    public static boolean reset$For$Test = false;
    private static final Object $$lock = new Object();
    public static T_2_34Public getTheT_2_3() throws PersistenceException{
        if (theT_2_3 == null || reset$For$Test){
            if (reset$For$Test) theT_2_3 = null;
            class Initializer implements Runnable {
                ...
                void produceSingleton() {
                    synchronized ($$lock){
                        try {
                            T_2_34Public proxi = null;
                            proxi = ConnectionHandler.getTheConnectionHandler().theT_2_3Facade.getTheT_2_3();
                            theT_2_3 = proxi;
                            if(proxi.getId() < 0) {
                ...
                T_2_34Public getResult() throws PersistenceException{
                    synchronized ($$lock) {
                        if (exception == null && theT_2_3== null) try {$$lock.wait();} catch (InterruptedException e) {}
    ...
    public T_2_3 provideCopy() throws PersistenceException{
        T_2_3 result = this;
        result = new T_2_3(this.subService, 
                           this.This, 
                           this.getId());
    ...
    public T_2_3(SubjInterface subService,PersistentGrade This,long id) throws PersistenceException {
    ...
    public PersistentT_2_3 getThis() throws PersistenceException {
        if(this.This == null){
            PersistentT_2_3 result = (PersistentT_2_3)PersistentProxi.createProxi(this.getId(),this.getClassId());
            result.getTheObject();
            return result;
        }return (PersistentT_2_3)this.This;
    }
    ...
    public void initialize(final Anything This, final java.util.HashMap<String,Object> final$$Fields) 
				throws PersistenceException{
        this.setThis((PersistentT_2_3)This);
    ...
    public common.Fraction toFraction() 
    	...
    	return new Fraction(BigInteger.valueOf(7), BigInteger.valueOf(3));
    }
