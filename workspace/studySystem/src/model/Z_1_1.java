...
public class Z_1_1 extends model.GradesInTenth implements PersistentZ_1_1{
    
    private static Z_1_14Public theZ_1_1 = null;
    public static boolean reset$For$Test = false;
    private static final Object $$lock = new Object();
    public static Z_1_14Public getTheZ_1_1() throws PersistenceException{
        if (theZ_1_1 == null || reset$For$Test){
            if (reset$For$Test) theZ_1_1 = null;
            class Initializer implements Runnable {
                ...
                void produceSingleton() {
                    synchronized ($$lock){
                        try {
                            Z_1_14Public proxi = null;
                            proxi = ConnectionHandler.getTheConnectionHandler().theZ_1_1Facade.getTheZ_1_1();
                            theZ_1_1 = proxi;
                            if(proxi.getId() < 0) {
                ...
                Z_1_14Public getResult() throws PersistenceException{
                    synchronized ($$lock) {
                        if (exception == null && theZ_1_1== null) try {$$lock.wait();} catch (InterruptedException e) {}
    ...
    public Z_1_1 provideCopy() throws PersistenceException{
        Z_1_1 result = this;
        result = new Z_1_1(this.subService, 
                           this.This, 
                           this.getId());
    ...
    public Z_1_1(SubjInterface subService,PersistentGrade This,long id) throws PersistenceException {
    ...
    public PersistentZ_1_1 getThis() throws PersistenceException {
        if(this.This == null){
            PersistentZ_1_1 result = (PersistentZ_1_1)PersistentProxi.createProxi(this.getId(),this.getClassId());
            result.getTheObject();
            return result;
        }return (PersistentZ_1_1)this.This;
    }
    ...
    public void initialize(final Anything This, final java.util.HashMap<String,Object> final$$Fields) 
				throws PersistenceException{
        this.setThis((PersistentZ_1_1)This);
    ...
    public common.Fraction toFraction() 
    	...
    	return new Fraction(BigInteger.valueOf(11), BigInteger.valueOf(10));
    }
