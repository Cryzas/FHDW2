...
public class T_2_0 extends model.GradesInThird implements PersistentT_2_0{
    ...
    public static T_2_04Public getTheT_2_0() throws PersistenceException{
        if (theT_2_0 == null || reset$For$Test){
            if (reset$For$Test) theT_2_0 = null;
            class Initializer implements Runnable {
                ...
                void produceSingleton() {
                    synchronized ($$lock){
                        try {
                            T_2_04Public proxi = null;
                            proxi = ConnectionHandler.getTheConnectionHandler().theT_2_0Facade.getTheT_2_0();
                            theT_2_0 = proxi;
                            if(proxi.getId() < 0) {
                ...
                T_2_04Public getResult() throws PersistenceException{
                    synchronized ($$lock) {
                        if (exception == null && theT_2_0== null) try {$$lock.wait();} catch (InterruptedException e) {}
    ...
    public T_2_0 provideCopy() throws PersistenceException{
        T_2_0 result = this;
        result = new T_2_0(this.subService, 
                           this.This, 
                           this.getId());
    ...
    public T_2_0(SubjInterface subService,PersistentGrade This,long id) throws PersistenceException {
    ...
    public PersistentT_2_0 getThis() throws PersistenceException {
        if(this.This == null){
            PersistentT_2_0 result = (PersistentT_2_0)PersistentProxi.createProxi(this.getId(),this.getClassId());
            result.getTheObject();
            return result;
        }return (PersistentT_2_0)this.This;
    }
    ...
    public void initialize(final Anything This, final java.util.HashMap<String,Object> final$$Fields) 
				throws PersistenceException{
        this.setThis((PersistentT_2_0)This);
    ...
    public common.Fraction toFraction() 
    	...
    	return new Fraction(BigInteger.valueOf(6), BigInteger.valueOf(3));
    }
