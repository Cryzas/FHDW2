...
public class Z_3_8 extends model.GradesInTenth implements PersistentZ_3_8{
    ...
    public Z_3_8 provideCopy() throws PersistenceException{
        Z_3_8 result = this;
        result = new Z_3_8(this.subService, 
                           this.This, 
                           this.getId());
    ...
    public Z_3_8(SubjInterface subService,PersistentGrade This,long id) throws PersistenceException {
    ...
    public common.Fraction toFraction() 
    	...
    	return new Fraction(BigInteger.valueOf(38), BigInteger.valueOf(10));
    }
