...
public class AlreadyExistsInParentException extends model.UserException{
    ...
    public AlreadyExistsInParentException(String message) throws PersistenceException {
        super(message);        
    }
