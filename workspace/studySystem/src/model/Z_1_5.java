...
public class Z_1_5 extends model.GradesInTenth implements PersistentZ_1_5{
    
    private static Z_1_54Public theZ_1_5 = null;
    public static boolean reset$For$Test = false;
    private static final Object $$lock = new Object();
    public static Z_1_54Public getTheZ_1_5() throws PersistenceException{
        if (theZ_1_5 == null || reset$For$Test){
            if (reset$For$Test) theZ_1_5 = null;
            class Initializer implements Runnable {
                ...
                void produceSingleton() {
                    synchronized ($$lock){
                        try {
                            Z_1_54Public proxi = null;
                            proxi = ConnectionHandler.getTheConnectionHandler().theZ_1_5Facade.getTheZ_1_5();
                            theZ_1_5 = proxi;
                            if(proxi.getId() < 0) {
                ...
                Z_1_54Public getResult() throws PersistenceException{
                    synchronized ($$lock) {
                        if (exception == null && theZ_1_5== null) try {$$lock.wait();} catch (InterruptedException e) {}
    ...
    public Z_1_5 provideCopy() throws PersistenceException{
        Z_1_5 result = this;
        result = new Z_1_5(this.subService, 
                           this.This, 
                           this.getId());
    ...
    public Z_1_5(SubjInterface subService,PersistentGrade This,long id) throws PersistenceException {
    ...
    public PersistentZ_1_5 getThis() throws PersistenceException {
        if(this.This == null){
            PersistentZ_1_5 result = (PersistentZ_1_5)PersistentProxi.createProxi(this.getId(),this.getClassId());
            result.getTheObject();
            return result;
        }return (PersistentZ_1_5)this.This;
    }
    ...
    public void initialize(final Anything This, final java.util.HashMap<String,Object> final$$Fields) 
				throws PersistenceException{
        this.setThis((PersistentZ_1_5)This);
    ...
    public common.Fraction toFraction() 
    	...
    	return new Fraction(BigInteger.valueOf(15), BigInteger.valueOf(10));
    }
