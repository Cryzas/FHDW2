...
public class StudyGroup extends PersistentObject implements PersistentStudyGroup{
    ...
    public StudyGroup(String name,PersistentProgramSGroup program,PersistentMyBoolean finished,SubjInterface subService,PersistentStudyGroup This,long id) throws PersistenceException {
    ...
    public void store() throws PersistenceException {
        ...
        if(this.getSubService() != null){
            ...
            ConnectionHandler.getTheConnectionHandler().theStudyGroupFacade.subServiceSet(this.getId(), getSubService());
        }
    ...
    public void setSubService(SubjInterface newValue) throws PersistenceException {
        ...
        if(!this.isDelayed$Persistence()){
            newValue.store();
            ConnectionHandler.getTheConnectionHandler().theStudyGroupFacade.subServiceSet(this.getId(), newValue);
        }
    }
