...
public class SimpleGradeSystem extends model.GradeSystem implements PersistentSimpleGradeSystem{
    ...
    public SimpleGradeSystem provideCopy() throws PersistenceException{
        ...
        result = new SimpleGradeSystem(this.subService, 
                                       this.This, 
                                       this.getId());
    ...
    public SimpleGradeSystem(SubjInterface subService,PersistentGradeSystem This,long id) throws PersistenceException {
