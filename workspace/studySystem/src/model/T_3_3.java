...
public class T_3_3 extends model.GradesInThird implements PersistentT_3_3{
    ...
    public T_3_3 provideCopy() throws PersistenceException{
        T_3_3 result = this;
        result = new T_3_3(this.subService, 
                           this.This, 
                           this.getId());
    ...
    public T_3_3(SubjInterface subService,PersistentGrade This,long id) throws PersistenceException {
    ...
    public common.Fraction toFraction() 
    	...
    	return new Fraction(BigInteger.valueOf(10), BigInteger.valueOf(3));
    }
