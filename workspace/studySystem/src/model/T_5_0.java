...
public class T_5_0 extends model.GradesInThird implements PersistentT_5_0{
    
    private static T_5_04Public theT_5_0 = null;
    public static boolean reset$For$Test = false;
    private static final Object $$lock = new Object();
    public static T_5_04Public getTheT_5_0() throws PersistenceException{
        if (theT_5_0 == null || reset$For$Test){
            if (reset$For$Test) theT_5_0 = null;
            class Initializer implements Runnable {
                ...
                void produceSingleton() {
                    synchronized ($$lock){
                        try {
                            T_5_04Public proxi = null;
                            proxi = ConnectionHandler.getTheConnectionHandler().theT_5_0Facade.getTheT_5_0();
                            theT_5_0 = proxi;
                            if(proxi.getId() < 0) {
                ...
                T_5_04Public getResult() throws PersistenceException{
                    synchronized ($$lock) {
                        if (exception == null && theT_5_0== null) try {$$lock.wait();} catch (InterruptedException e) {}
    ...
    public T_5_0 provideCopy() throws PersistenceException{
        T_5_0 result = this;
        result = new T_5_0(this.subService, 
                           this.This, 
                           this.getId());
    ...
    public T_5_0(SubjInterface subService,PersistentGrade This,long id) throws PersistenceException {
    ...
    public PersistentT_5_0 getThis() throws PersistenceException {
        if(this.This == null){
            PersistentT_5_0 result = (PersistentT_5_0)PersistentProxi.createProxi(this.getId(),this.getClassId());
            result.getTheObject();
            return result;
        }return (PersistentT_5_0)this.This;
    }
    ...
    public void initialize(final Anything This, final java.util.HashMap<String,Object> final$$Fields) 
				throws PersistenceException{
        this.setThis((PersistentT_5_0)This);
    ...
    public common.Fraction toFraction() 
    	...
    	return new Fraction(BigInteger.valueOf(15), BigInteger.valueOf(3));
    }
