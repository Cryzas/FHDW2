...
public class Z_1_4 extends model.GradesInTenth implements PersistentZ_1_4{
    ...
    public Z_1_4 provideCopy() throws PersistenceException{
        Z_1_4 result = this;
        result = new Z_1_4(this.subService, 
                           this.This, 
                           this.getId());
    ...
    public Z_1_4(SubjInterface subService,PersistentGrade This,long id) throws PersistenceException {
    ...
    public common.Fraction toFraction() 
    	...
    	return new Fraction(BigInteger.valueOf(14), BigInteger.valueOf(10));
    }
