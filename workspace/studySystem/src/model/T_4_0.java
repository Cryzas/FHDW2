...
public class T_4_0 extends model.GradesInThird implements PersistentT_4_0{
    
    private static T_4_04Public theT_4_0 = null;
    public static boolean reset$For$Test = false;
    private static final Object $$lock = new Object();
    public static T_4_04Public getTheT_4_0() throws PersistenceException{
        if (theT_4_0 == null || reset$For$Test){
            if (reset$For$Test) theT_4_0 = null;
            class Initializer implements Runnable {
                ...
                void produceSingleton() {
                    synchronized ($$lock){
                        try {
                            T_4_04Public proxi = null;
                            proxi = ConnectionHandler.getTheConnectionHandler().theT_4_0Facade.getTheT_4_0();
                            theT_4_0 = proxi;
                            if(proxi.getId() < 0) {
                ...
                T_4_04Public getResult() throws PersistenceException{
                    synchronized ($$lock) {
                        if (exception == null && theT_4_0== null) try {$$lock.wait();} catch (InterruptedException e) {}
    ...
    public T_4_0 provideCopy() throws PersistenceException{
        T_4_0 result = this;
        result = new T_4_0(this.subService, 
                           this.This, 
                           this.getId());
    ...
    public T_4_0(SubjInterface subService,PersistentGrade This,long id) throws PersistenceException {
    ...
    public PersistentT_4_0 getThis() throws PersistenceException {
        if(this.This == null){
            PersistentT_4_0 result = (PersistentT_4_0)PersistentProxi.createProxi(this.getId(),this.getClassId());
            result.getTheObject();
            return result;
        }return (PersistentT_4_0)this.This;
    }
    
    public void accept(GradesInThirdVisitor visitor) throws PersistenceException {
        visitor.handleT_4_0(this);
    }
    public <R> R accept(GradesInThirdReturnVisitor<R>  visitor) throws PersistenceException {
         return visitor.handleT_4_0(this);
    }
    ...
    public void initialize(final Anything This, final java.util.HashMap<String,Object> final$$Fields) 
				throws PersistenceException{
        this.setThis((PersistentT_4_0)This);
    ...
    public common.Fraction toFraction() 
    	...
    	return new Fraction(BigInteger.valueOf(12), BigInteger.valueOf(3));
    }
