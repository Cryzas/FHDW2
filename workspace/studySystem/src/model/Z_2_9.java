...
public class Z_2_9 extends model.GradesInTenth implements PersistentZ_2_9{
    
    private static Z_2_94Public theZ_2_9 = null;
    public static boolean reset$For$Test = false;
    private static final Object $$lock = new Object();
    public static Z_2_94Public getTheZ_2_9() throws PersistenceException{
        if (theZ_2_9 == null || reset$For$Test){
            if (reset$For$Test) theZ_2_9 = null;
            class Initializer implements Runnable {
                ...
                void produceSingleton() {
                    synchronized ($$lock){
                        try {
                            Z_2_94Public proxi = null;
                            proxi = ConnectionHandler.getTheConnectionHandler().theZ_2_9Facade.getTheZ_2_9();
                            theZ_2_9 = proxi;
                            if(proxi.getId() < 0) {
                ...
                Z_2_94Public getResult() throws PersistenceException{
                    synchronized ($$lock) {
                        if (exception == null && theZ_2_9== null) try {$$lock.wait();} catch (InterruptedException e) {}
    ...
    public Z_2_9 provideCopy() throws PersistenceException{
        Z_2_9 result = this;
        result = new Z_2_9(this.subService, 
                           this.This, 
                           this.getId());
    ...
    public Z_2_9(SubjInterface subService,PersistentGrade This,long id) throws PersistenceException {
    ...
    public PersistentZ_2_9 getThis() throws PersistenceException {
        if(this.This == null){
            PersistentZ_2_9 result = (PersistentZ_2_9)PersistentProxi.createProxi(this.getId(),this.getClassId());
            result.getTheObject();
            return result;
        }return (PersistentZ_2_9)this.This;
    }
    ...
    public void initialize(final Anything This, final java.util.HashMap<String,Object> final$$Fields) 
				throws PersistenceException{
        this.setThis((PersistentZ_2_9)This);
    ...
    public common.Fraction toFraction() 
    	...
    	return new Fraction(BigInteger.valueOf(29), BigInteger.valueOf(10));
    }
