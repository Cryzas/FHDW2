...
public class Z_1_9 extends model.GradesInTenth implements PersistentZ_1_9{
    
    private static Z_1_94Public theZ_1_9 = null;
    public static boolean reset$For$Test = false;
    private static final Object $$lock = new Object();
    public static Z_1_94Public getTheZ_1_9() throws PersistenceException{
        if (theZ_1_9 == null || reset$For$Test){
            if (reset$For$Test) theZ_1_9 = null;
            class Initializer implements Runnable {
                ...
                void produceSingleton() {
                    synchronized ($$lock){
                        try {
                            Z_1_94Public proxi = null;
                            proxi = ConnectionHandler.getTheConnectionHandler().theZ_1_9Facade.getTheZ_1_9();
                            theZ_1_9 = proxi;
                            if(proxi.getId() < 0) {
                ...
                Z_1_94Public getResult() throws PersistenceException{
                    synchronized ($$lock) {
                        if (exception == null && theZ_1_9== null) try {$$lock.wait();} catch (InterruptedException e) {}
    ...
    public Z_1_9 provideCopy() throws PersistenceException{
        Z_1_9 result = this;
        result = new Z_1_9(this.subService, 
                           this.This, 
                           this.getId());
    ...
    public Z_1_9(SubjInterface subService,PersistentGrade This,long id) throws PersistenceException {
    ...
    public PersistentZ_1_9 getThis() throws PersistenceException {
        if(this.This == null){
            PersistentZ_1_9 result = (PersistentZ_1_9)PersistentProxi.createProxi(this.getId(),this.getClassId());
            result.getTheObject();
            return result;
        }return (PersistentZ_1_9)this.This;
    }
    ...
    public void initialize(final Anything This, final java.util.HashMap<String,Object> final$$Fields) 
				throws PersistenceException{
        this.setThis((PersistentZ_1_9)This);
    ...
    public common.Fraction toFraction() 
    	...
    	return new Fraction(BigInteger.valueOf(19), BigInteger.valueOf(10));
    }
