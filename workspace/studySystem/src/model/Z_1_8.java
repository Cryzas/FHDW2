...
public class Z_1_8 extends model.GradesInTenth implements PersistentZ_1_8{
    
    private static Z_1_84Public theZ_1_8 = null;
    public static boolean reset$For$Test = false;
    private static final Object $$lock = new Object();
    public static Z_1_84Public getTheZ_1_8() throws PersistenceException{
        if (theZ_1_8 == null || reset$For$Test){
            if (reset$For$Test) theZ_1_8 = null;
            class Initializer implements Runnable {
                ...
                void produceSingleton() {
                    synchronized ($$lock){
                        try {
                            Z_1_84Public proxi = null;
                            proxi = ConnectionHandler.getTheConnectionHandler().theZ_1_8Facade.getTheZ_1_8();
                            theZ_1_8 = proxi;
                            if(proxi.getId() < 0) {
                ...
                Z_1_84Public getResult() throws PersistenceException{
                    synchronized ($$lock) {
                        if (exception == null && theZ_1_8== null) try {$$lock.wait();} catch (InterruptedException e) {}
    ...
    public Z_1_8 provideCopy() throws PersistenceException{
        Z_1_8 result = this;
        result = new Z_1_8(this.subService, 
                           this.This, 
                           this.getId());
    ...
    public Z_1_8(SubjInterface subService,PersistentGrade This,long id) throws PersistenceException {
    ...
    public PersistentZ_1_8 getThis() throws PersistenceException {
        if(this.This == null){
            PersistentZ_1_8 result = (PersistentZ_1_8)PersistentProxi.createProxi(this.getId(),this.getClassId());
            result.getTheObject();
            return result;
        }return (PersistentZ_1_8)this.This;
    }
    ...
    public void initialize(final Anything This, final java.util.HashMap<String,Object> final$$Fields) 
				throws PersistenceException{
        this.setThis((PersistentZ_1_8)This);
    ...
    public common.Fraction toFraction() 
    	...
    	return new Fraction(BigInteger.valueOf(18), BigInteger.valueOf(10));
    }
