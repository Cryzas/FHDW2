...
public class Z_2_7 extends model.GradesInTenth implements PersistentZ_2_7{
    ...
    public Z_2_7 provideCopy() throws PersistenceException{
        Z_2_7 result = this;
        result = new Z_2_7(this.subService, 
                           this.This, 
                           this.getId());
    ...
    public Z_2_7(SubjInterface subService,PersistentGrade This,long id) throws PersistenceException {
    ...
    public common.Fraction toFraction() 
    	...
    	return new Fraction(BigInteger.valueOf(27), BigInteger.valueOf(10));
    }
