...
public class T_3_7 extends model.GradesInThird implements PersistentT_3_7{
    
    private static T_3_74Public theT_3_7 = null;
    public static boolean reset$For$Test = false;
    private static final Object $$lock = new Object();
    public static T_3_74Public getTheT_3_7() throws PersistenceException{
        if (theT_3_7 == null || reset$For$Test){
            if (reset$For$Test) theT_3_7 = null;
            class Initializer implements Runnable {
                ...
                void produceSingleton() {
                    synchronized ($$lock){
                        try {
                            T_3_74Public proxi = null;
                            proxi = ConnectionHandler.getTheConnectionHandler().theT_3_7Facade.getTheT_3_7();
                            theT_3_7 = proxi;
                            if(proxi.getId() < 0) {
                ...
                T_3_74Public getResult() throws PersistenceException{
                    synchronized ($$lock) {
                        if (exception == null && theT_3_7== null) try {$$lock.wait();} catch (InterruptedException e) {}
    ...
    public T_3_7 provideCopy() throws PersistenceException{
        T_3_7 result = this;
        result = new T_3_7(this.subService, 
                           this.This, 
                           this.getId());
    ...
    public T_3_7(SubjInterface subService,PersistentGrade This,long id) throws PersistenceException {
    ...
    public PersistentT_3_7 getThis() throws PersistenceException {
        if(this.This == null){
            PersistentT_3_7 result = (PersistentT_3_7)PersistentProxi.createProxi(this.getId(),this.getClassId());
            result.getTheObject();
            return result;
        }return (PersistentT_3_7)this.This;
    }
    ...
    public void initialize(final Anything This, final java.util.HashMap<String,Object> final$$Fields) 
				throws PersistenceException{
        this.setThis((PersistentT_3_7)This);
    ...
    public common.Fraction toFraction() 
    	...
    	return new Fraction(BigInteger.valueOf(11), BigInteger.valueOf(3));
    }
