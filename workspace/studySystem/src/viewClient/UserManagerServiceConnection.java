...
public class UserManagerServiceConnection extends subAdminServiceConnection {

	public UserManagerServiceConnection (String url, ExceptionAndEventHandler handler, ClientReporter reporter) throws MalformedURLException {
		super(url, handler, reporter);
	}

	public UserManagerServiceView getUserManagerServiceView(){
		return (UserManagerServiceView)super.getServer();
	}

    public synchronized String userManagerService_Menu_Filter(Anything anything) throws ModelException{
        try {
            ...
            java.util.HashMap<?,?> success = (java.util.HashMap<?,?>)this.execute(this.connectionName, "userManagerService_Menu_Filter", parameters);
