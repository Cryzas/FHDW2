...
public class subAdminServiceConnection extends ConnectionMaster {

	public subAdminServiceConnection (String url, ExceptionAndEventHandler handler, ClientReporter reporter) throws MalformedURLException {
		super(url, handler, reporter);
	}

	public subAdminServiceView getsubAdminServiceView(){
		return (subAdminServiceView)super.getServer();
	}
