...
public class CycleException extends view.UserException{
    ...
    public static CycleException fromHashtableToCycleException(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
