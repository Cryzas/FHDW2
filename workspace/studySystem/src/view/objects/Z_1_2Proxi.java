...
public class Z_1_2Proxi extends GradesInTenthProxi implements Z_1_2View{
    
    public Z_1_2Proxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public Z_1_2View getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        Z_1_2View result$$ = new Z_1_2( this.getId(), this.getClassId());
