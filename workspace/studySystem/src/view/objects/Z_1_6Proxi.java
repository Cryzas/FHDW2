...
public class Z_1_6Proxi extends GradesInTenthProxi implements Z_1_6View{
    
    public Z_1_6Proxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public Z_1_6View getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        Z_1_6View result$$ = new Z_1_6( this.getId(), this.getClassId());
