...
public class Z_3_0Proxi extends GradesInTenthProxi implements Z_3_0View{
    
    public Z_3_0Proxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public Z_3_0View getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        Z_3_0View result$$ = new Z_3_0( this.getId(), this.getClassId());
