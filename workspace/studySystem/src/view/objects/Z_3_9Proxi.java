...
public class Z_3_9Proxi extends GradesInTenthProxi implements Z_3_9View{
    
    public Z_3_9Proxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public Z_3_9View getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        Z_3_9View result$$ = new Z_3_9( this.getId(), this.getClassId());
