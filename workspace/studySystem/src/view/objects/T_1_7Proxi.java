...
public class T_1_7Proxi extends GradesInThirdProxi implements T_1_7View{
    
    public T_1_7Proxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public T_1_7View getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        T_1_7View result$$ = new T_1_7( this.getId(), this.getClassId());
