...
public class T_3_3Proxi extends GradesInThirdProxi implements T_3_3View{
    
    public T_3_3Proxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public T_3_3View getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        T_3_3View result$$ = new T_3_3( this.getId(), this.getClassId());
