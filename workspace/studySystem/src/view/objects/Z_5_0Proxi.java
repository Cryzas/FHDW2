...
public class Z_5_0Proxi extends GradesInTenthProxi implements Z_5_0View{
    
    public Z_5_0Proxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public Z_5_0View getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        Z_5_0View result$$ = new Z_5_0( this.getId(), this.getClassId());
