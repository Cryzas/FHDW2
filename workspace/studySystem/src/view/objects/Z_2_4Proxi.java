...
public class Z_2_4Proxi extends GradesInTenthProxi implements Z_2_4View{
    
    public Z_2_4Proxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public Z_2_4View getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        Z_2_4View result$$ = new Z_2_4( this.getId(), this.getClassId());
