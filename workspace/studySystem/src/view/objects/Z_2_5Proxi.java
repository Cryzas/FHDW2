...
public class Z_2_5Proxi extends GradesInTenthProxi implements Z_2_5View{
    
    public Z_2_5Proxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public Z_2_5View getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        Z_2_5View result$$ = new Z_2_5( this.getId(), this.getClassId());
