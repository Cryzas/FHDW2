...
public class Z_1_9Proxi extends GradesInTenthProxi implements Z_1_9View{
    
    public Z_1_9Proxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public Z_1_9View getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        Z_1_9View result$$ = new Z_1_9( this.getId(), this.getClassId());
