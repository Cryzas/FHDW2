...
public class Z_3_6Proxi extends GradesInTenthProxi implements Z_3_6View{
    
    public Z_3_6Proxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public Z_3_6View getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        Z_3_6View result$$ = new Z_3_6( this.getId(), this.getClassId());
