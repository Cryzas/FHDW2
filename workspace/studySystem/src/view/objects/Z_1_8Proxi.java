...
public class Z_1_8Proxi extends GradesInTenthProxi implements Z_1_8View{
    
    public Z_1_8Proxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public Z_1_8View getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        Z_1_8View result$$ = new Z_1_8( this.getId(), this.getClassId());
