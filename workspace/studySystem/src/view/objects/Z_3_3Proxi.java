...
public class Z_3_3Proxi extends GradesInTenthProxi implements Z_3_3View{
    
    public Z_3_3Proxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public Z_3_3View getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        Z_3_3View result$$ = new Z_3_3( this.getId(), this.getClassId());
