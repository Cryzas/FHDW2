...
public class NoGradeProxi extends GradesInThirdProxi implements NoGradeView{
    
    public NoGradeProxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public NoGradeView getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        NoGradeView result$$ = new NoGrade( this.getId(), this.getClassId());
