...
public class Z_3_1Proxi extends GradesInTenthProxi implements PersistentZ_3_1{
    
    public Z_3_1Proxi(long objectId) {
        super(objectId);
    }
    public Z_3_1Proxi(PersistentInCacheProxi object) {
        super(object);
    }
