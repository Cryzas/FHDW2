...
public abstract class PersistentInCacheProxi extends PersistentRoot {
	  ...
	  private static ICProxiFactory [] getTheICProxiFactories(){
		if (iCProxiFactories == null){
			iCProxiFactories = new ICProxiFactory[214];
        ...
        iCProxiFactories[184] = new ICProxiFactory(){
            PersistentInCacheProxi create(long objectId){
                return new NoProgramICProxi(objectId);
            }
        };
        ...
        iCProxiFactories[175] = new ICProxiFactory(){
            PersistentInCacheProxi create(long objectId){
                return new GradeChangeICProxi(objectId);
            }
        };
        ...
        iCProxiFactories[185] = new ICProxiFactory(){
            PersistentInCacheProxi create(long objectId){
                return new StudentServiceICProxi(objectId);
            }
        };
        iCProxiFactories[181] = new ICProxiFactory(){
            PersistentInCacheProxi create(long objectId){
                return new BFalseICProxi(objectId);
            }
        };
        ...
        iCProxiFactories[183] = new ICProxiFactory(){
            PersistentInCacheProxi create(long objectId){
                return new EndStudyGroupCommandICProxi(objectId);
            }
        };
        ...
        iCProxiFactories[172] = new ICProxiFactory(){
            PersistentInCacheProxi create(long objectId){
                return new NoGradeICProxi(objectId);
            }
        };
