...
public class Z_1_7Proxi extends GradesInTenthProxi implements PersistentZ_1_7{
    
    public Z_1_7Proxi(long objectId) {
        super(objectId);
    }
    public Z_1_7Proxi(PersistentInCacheProxi object) {
        super(object);
    }
    ...
    public void deregister(final ObsInterface observee) 
        ...
        ((PersistentZ_1_7)this.getTheObject()).deregister(observee);
    }
    ...
    public void register(final ObsInterface observee) 
				throws PersistenceException{
        ((PersistentZ_1_7)this.getTheObject()).register(observee);
    }
    public void updateObservers(final model.meta.Mssgs event) 
				throws PersistenceException{
        ((PersistentZ_1_7)this.getTheObject()).updateObservers(event);
    }
    ...
    public common.Fraction toFraction() 
        ...
        return ((PersistentZ_1_7)this.getTheObject()).toFraction();
    }
