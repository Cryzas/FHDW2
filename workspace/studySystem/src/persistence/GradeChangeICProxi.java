...
public class GradeChangeICProxi extends PersistentInCacheProxiOptimistic implements PersistentGradeChange{
    
    public GradeChangeICProxi(long objectId) {
        super(objectId);
    }
    public GradeChangeICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theGradeChangeFacade
            .getGradeChange(this.getId());
    }
