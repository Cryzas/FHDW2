...
public class T_3_7Proxi extends GradesInThirdProxi implements PersistentT_3_7{
    
    public T_3_7Proxi(long objectId) {
        super(objectId);
    }
    public T_3_7Proxi(PersistentInCacheProxi object) {
        super(object);
    }
    ...
    public void deregister(final ObsInterface observee) 
        ...
        ((PersistentT_3_7)this.getTheObject()).deregister(observee);
    }
    ...
    public void register(final ObsInterface observee) 
				throws PersistenceException{
        ((PersistentT_3_7)this.getTheObject()).register(observee);
    }
    public void updateObservers(final model.meta.Mssgs event) 
				throws PersistenceException{
        ((PersistentT_3_7)this.getTheObject()).updateObservers(event);
    }
