...
public class Z_3_0Proxi extends GradesInTenthProxi implements PersistentZ_3_0{
    
    public Z_3_0Proxi(long objectId) {
        super(objectId);
    }
    public Z_3_0Proxi(PersistentInCacheProxi object) {
        super(object);
    }
    ...
    public void deregister(final ObsInterface observee) 
        ...
        ((PersistentZ_3_0)this.getTheObject()).deregister(observee);
    }
    ...
    public void register(final ObsInterface observee) 
				throws PersistenceException{
        ((PersistentZ_3_0)this.getTheObject()).register(observee);
    }
    public void updateObservers(final model.meta.Mssgs event) 
				throws PersistenceException{
        ((PersistentZ_3_0)this.getTheObject()).updateObservers(event);
    }
    ...
    public common.Fraction toFraction() 
        ...
        return ((PersistentZ_3_0)this.getTheObject()).toFraction();
    }
