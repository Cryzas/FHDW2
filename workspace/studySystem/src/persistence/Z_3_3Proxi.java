...
public class Z_3_3Proxi extends GradesInTenthProxi implements PersistentZ_3_3{
    
    public Z_3_3Proxi(long objectId) {
        super(objectId);
    }
    public Z_3_3Proxi(PersistentInCacheProxi object) {
        super(object);
    }
    ...
    public void deregister(final ObsInterface observee) 
        ...
        ((PersistentZ_3_3)this.getTheObject()).deregister(observee);
    }
    ...
    public void register(final ObsInterface observee) 
				throws PersistenceException{
        ((PersistentZ_3_3)this.getTheObject()).register(observee);
    }
    public void updateObservers(final model.meta.Mssgs event) 
				throws PersistenceException{
        ((PersistentZ_3_3)this.getTheObject()).updateObservers(event);
    }
