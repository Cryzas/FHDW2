...
public class Z_1_6Proxi extends GradesInTenthProxi implements PersistentZ_1_6{
    
    public Z_1_6Proxi(long objectId) {
        super(objectId);
    }
    public Z_1_6Proxi(PersistentInCacheProxi object) {
        super(object);
    }
    ...
    public void deregister(final ObsInterface observee) 
        ...
        ((PersistentZ_1_6)this.getTheObject()).deregister(observee);
    }
    ...
    public void register(final ObsInterface observee) 
				throws PersistenceException{
        ((PersistentZ_1_6)this.getTheObject()).register(observee);
    }
    public void updateObservers(final model.meta.Mssgs event) 
				throws PersistenceException{
        ((PersistentZ_1_6)this.getTheObject()).updateObservers(event);
    }
    ...
    public common.Fraction toFraction() 
        ...
        return ((PersistentZ_1_6)this.getTheObject()).toFraction();
    }
