...
public class EndStudyGroupCommandICProxi extends PersistentInCacheProxi implements PersistentEndStudyGroupCommand{
    
    public EndStudyGroupCommandICProxi(long objectId) {
        super(objectId);
    }
    public EndStudyGroupCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theEndStudyGroupCommandFacade
            .getEndStudyGroupCommand(this.getId());
    }
