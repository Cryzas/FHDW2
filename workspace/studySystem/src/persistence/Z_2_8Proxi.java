...
public class Z_2_8Proxi extends GradesInTenthProxi implements PersistentZ_2_8{
    
    public Z_2_8Proxi(long objectId) {
        super(objectId);
    }
    public Z_2_8Proxi(PersistentInCacheProxi object) {
        super(object);
    }
