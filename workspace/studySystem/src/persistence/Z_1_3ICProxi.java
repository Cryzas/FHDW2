...
public class Z_1_3ICProxi extends GradesInTenthICProxi implements PersistentZ_1_3{
    
    public Z_1_3ICProxi(long objectId) {
        super(objectId);
    }
    public Z_1_3ICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theZ_1_3Facade
            .getZ_1_3(this.getId());
    }
    ...
    public void deregister(final ObsInterface observee) 
        ...
        ((PersistentZ_1_3)this.getTheObject()).deregister(observee);
    }
    ...
    public void register(final ObsInterface observee) 
				throws PersistenceException{
        ((PersistentZ_1_3)this.getTheObject()).register(observee);
    }
    public void updateObservers(final model.meta.Mssgs event) 
				throws PersistenceException{
        ((PersistentZ_1_3)this.getTheObject()).updateObservers(event);
    }
    ...
    public common.Fraction toFraction() 
        ...
        return ((PersistentZ_1_3)this.getTheObject()).toFraction();
    }
