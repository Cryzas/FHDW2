...
public class StudentServiceICProxi extends ServiceICProxi implements PersistentStudentService{
    
    public StudentServiceICProxi(long objectId) {
        super(objectId);
    }
    public StudentServiceICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theStudentServiceFacade
            .getStudentService(this.getId());
    }
