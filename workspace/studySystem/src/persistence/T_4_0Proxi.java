...
public class T_4_0Proxi extends GradesInThirdProxi implements PersistentT_4_0{
    
    public T_4_0Proxi(long objectId) {
        super(objectId);
    }
    public T_4_0Proxi(PersistentInCacheProxi object) {
        super(object);
    }
