...
public class ChangeGradeCommandProxi extends PersistentProxi implements PersistentChangeGradeCommand{
    
    public ChangeGradeCommandProxi(long objectId) {
        super(objectId);
    }
    public ChangeGradeCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
