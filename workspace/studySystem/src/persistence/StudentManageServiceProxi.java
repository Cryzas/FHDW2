...
public class StudentManageServiceProxi extends subAdminServiceProxi implements PersistentStudentManageService{
    
    public StudentManageServiceProxi(long objectId) {
        super(objectId);
    }
    public StudentManageServiceProxi(PersistentInCacheProxi object) {
        super(object);
    }
