...
public class PassedICProxi extends GradesInSimpleICProxi implements PersistentPassed{
    ...
    public void deregister(final ObsInterface observee) 
        ...
        ((PersistentPassed)this.getTheObject()).deregister(observee);
    }
    ...
    public void register(final ObsInterface observee) 
				throws PersistenceException{
        ((PersistentPassed)this.getTheObject()).register(observee);
    }
    public void updateObservers(final model.meta.Mssgs event) 
				throws PersistenceException{
        ((PersistentPassed)this.getTheObject()).updateObservers(event);
    }
