...
public class Z_1_4Proxi extends GradesInTenthProxi implements PersistentZ_1_4{
    
    public Z_1_4Proxi(long objectId) {
        super(objectId);
    }
    public Z_1_4Proxi(PersistentInCacheProxi object) {
        super(object);
    }
