...
public abstract class ModuleAbstractProxi extends PersistentProxi implements PersistentModuleAbstract{
    
    public ModuleAbstractProxi(long objectId) {
        super(objectId);
    }
    public ModuleAbstractProxi(PersistentInCacheProxi object) {
        super(object);
    }
