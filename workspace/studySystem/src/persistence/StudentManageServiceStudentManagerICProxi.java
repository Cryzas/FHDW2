...
public class StudentManageServiceStudentManagerICProxi extends PersistentInCacheProxiOptimistic implements PersistentStudentManageServiceStudentManager{
    
    public StudentManageServiceStudentManagerICProxi(long objectId) {
        super(objectId);
    }
    public StudentManageServiceStudentManagerICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theStudentManageServiceStudentManagerFacade
            .getStudentManageServiceStudentManager(this.getId());
    }
