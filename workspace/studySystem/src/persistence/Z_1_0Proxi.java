...
public class Z_1_0Proxi extends GradesInTenthProxi implements PersistentZ_1_0{
    
    public Z_1_0Proxi(long objectId) {
        super(objectId);
    }
    public Z_1_0Proxi(PersistentInCacheProxi object) {
        super(object);
    }
