...
public class ModuleWithUnitsStudentProxi extends ModuleAbstractStudentProxi implements PersistentModuleWithUnitsStudent{
    
    public ModuleWithUnitsStudentProxi(long objectId) {
        super(objectId);
    }
    public ModuleWithUnitsStudentProxi(PersistentInCacheProxi object) {
        super(object);
    }
    ...
    public void deregister(final ObsInterface observee) 
				throws PersistenceException{
        ((PersistentModuleWithUnitsStudent)this.getTheObject()).deregister(observee);
    }
    ...
    public void register(final ObsInterface observee) 
				throws PersistenceException{
        ((PersistentModuleWithUnitsStudent)this.getTheObject()).register(observee);
    }
    ...
    public void updateObservers(final model.meta.Mssgs event) 
				throws PersistenceException{
        ((PersistentModuleWithUnitsStudent)this.getTheObject()).updateObservers(event);
    }
