...
public class StudyGroupServiceGroupManagerProxi extends PersistentProxi implements PersistentStudyGroupServiceGroupManager{
    
    public StudyGroupServiceGroupManagerProxi(long objectId) {
        super(objectId);
    }
    public StudyGroupServiceGroupManagerProxi(PersistentInCacheProxi object) {
        super(object);
    }
