...
public class Z_1_1ICProxi extends GradesInTenthICProxi implements PersistentZ_1_1{
    
    public Z_1_1ICProxi(long objectId) {
        super(objectId);
    }
    public Z_1_1ICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theZ_1_1Facade
            .getZ_1_1(this.getId());
    }
    ...
    public void deregister(final ObsInterface observee) 
        ...
        ((PersistentZ_1_1)this.getTheObject()).deregister(observee);
    }
    ...
    public void register(final ObsInterface observee) 
				throws PersistenceException{
        ((PersistentZ_1_1)this.getTheObject()).register(observee);
    }
    public void updateObservers(final model.meta.Mssgs event) 
				throws PersistenceException{
        ((PersistentZ_1_1)this.getTheObject()).updateObservers(event);
    }
    ...
    public common.Fraction toFraction() 
        ...
        return ((PersistentZ_1_1)this.getTheObject()).toFraction();
    }
