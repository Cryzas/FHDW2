...
public class Z_2_5Proxi extends GradesInTenthProxi implements PersistentZ_2_5{
    
    public Z_2_5Proxi(long objectId) {
        super(objectId);
    }
    public Z_2_5Proxi(PersistentInCacheProxi object) {
        super(object);
    }
