...
public class ProgramModuleServiceICProxi extends subAdminServiceICProxi implements PersistentProgramModuleService{
    
    public ProgramModuleServiceICProxi(long objectId) {
        super(objectId);
    }
    public ProgramModuleServiceICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theProgramModuleServiceFacade
            .getProgramModuleService(this.getId());
    }
