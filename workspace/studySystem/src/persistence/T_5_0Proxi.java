...
public class T_5_0Proxi extends GradesInThirdProxi implements PersistentT_5_0{
    
    public T_5_0Proxi(long objectId) {
        super(objectId);
    }
    public T_5_0Proxi(PersistentInCacheProxi object) {
        super(object);
    }
