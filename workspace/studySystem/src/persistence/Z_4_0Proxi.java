...
public class Z_4_0Proxi extends GradesInTenthProxi implements PersistentZ_4_0{
    
    public Z_4_0Proxi(long objectId) {
        super(objectId);
    }
    public Z_4_0Proxi(PersistentInCacheProxi object) {
        super(object);
    }
