...
public class T_2_7Proxi extends GradesInThirdProxi implements PersistentT_2_7{
    
    public T_2_7Proxi(long objectId) {
        super(objectId);
    }
    public T_2_7Proxi(PersistentInCacheProxi object) {
        super(object);
    }
    ...
    public void deregister(final ObsInterface observee) 
        ...
        ((PersistentT_2_7)this.getTheObject()).deregister(observee);
    }
    ...
    public void register(final ObsInterface observee) 
				throws PersistenceException{
        ((PersistentT_2_7)this.getTheObject()).register(observee);
    }
    public void updateObservers(final model.meta.Mssgs event) 
				throws PersistenceException{
        ((PersistentT_2_7)this.getTheObject()).updateObservers(event);
    }
