...
public class AdminServiceServicesICProxi extends PersistentInCacheProxiOptimistic implements PersistentAdminServiceServices{
    
    public AdminServiceServicesICProxi(long objectId) {
        super(objectId);
    }
    public AdminServiceServicesICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theAdminServiceServicesFacade
            .getAdminServiceServices(this.getId());
    }
