...
public class Z_1_2Proxi extends GradesInTenthProxi implements PersistentZ_1_2{
    
    public Z_1_2Proxi(long objectId) {
        super(objectId);
    }
    public Z_1_2Proxi(PersistentInCacheProxi object) {
        super(object);
    }
    ...
    public void deregister(final ObsInterface observee) 
        ...
        ((PersistentZ_1_2)this.getTheObject()).deregister(observee);
    }
    ...
    public void register(final ObsInterface observee) 
				throws PersistenceException{
        ((PersistentZ_1_2)this.getTheObject()).register(observee);
    }
    public void updateObservers(final model.meta.Mssgs event) 
				throws PersistenceException{
        ((PersistentZ_1_2)this.getTheObject()).updateObservers(event);
    }
