...
public class Z_2_0Proxi extends GradesInTenthProxi implements PersistentZ_2_0{
    
    public Z_2_0Proxi(long objectId) {
        super(objectId);
    }
    public Z_2_0Proxi(PersistentInCacheProxi object) {
        super(object);
    }
