...
public class UnitSGroupFacade{
    ...
    public PersistentUnitSGroup newUnitSGroup(common.Fraction creditPoints,long idCreateIfLessZero) throws PersistenceException {
        ...
        try{
            ...
            callable.close();
            UnitSGroup result = new UnitSGroup(null,creditPoints,null,null,null,id);
    ...
    public UnitSGroup getUnitSGroup(long UnitSGroupId) throws PersistenceException{
        try{
            ...
            if (obj.getLong(9) != 0)
                This = (PersistentUnitSGroup)PersistentProxi.createProxi(obj.getLong(9), obj.getLong(10));
    ...
    public void subServiceSet(long UnitSGroupId, SubjInterface subServiceVal) throws PersistenceException {
        try{
            CallableStatement callable;
            callable = this.con.prepareCall("Begin " + this.schemaName + ".UntSGrpFacade.sbSrvcSet(?, ?, ?); end;");
            callable.setLong(1, UnitSGroupId);
