...
public class T_3_0Proxi extends GradesInThirdProxi implements PersistentT_3_0{
    
    public T_3_0Proxi(long objectId) {
        super(objectId);
    }
    public T_3_0Proxi(PersistentInCacheProxi object) {
        super(object);
    }
