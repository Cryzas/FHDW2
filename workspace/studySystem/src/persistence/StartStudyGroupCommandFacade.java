...
public class StartStudyGroupCommandFacade{
    ...
    public PersistentStartStudyGroupCommand newStartStudyGroupCommand(String name,long idCreateIfLessZero) throws PersistenceException {
        if(idCreateIfLessZero > 0) return (PersistentStartStudyGroupCommand)PersistentProxi.createProxi(idCreateIfLessZero, 313);
        ...
        return (PersistentStartStudyGroupCommand)PersistentProxi.createProxi(id, 313);
    }
    ...
    public long getClass(long objectId) throws PersistenceException{
        if(Cache.getTheCache().contains(objectId, 313)) return 313;
