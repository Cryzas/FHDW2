...
public class Z_2_2Proxi extends GradesInTenthProxi implements PersistentZ_2_2{
    
    public Z_2_2Proxi(long objectId) {
        super(objectId);
    }
    public Z_2_2Proxi(PersistentInCacheProxi object) {
        super(object);
    }
