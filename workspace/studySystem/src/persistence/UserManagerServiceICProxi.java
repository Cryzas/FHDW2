...
public class UserManagerServiceICProxi extends subAdminServiceICProxi implements PersistentUserManagerService{
    
    public UserManagerServiceICProxi(long objectId) {
        super(objectId);
    }
    public UserManagerServiceICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theUserManagerServiceFacade
            .getUserManagerService(this.getId());
    }
