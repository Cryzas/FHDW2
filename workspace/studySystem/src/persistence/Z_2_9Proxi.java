...
public class Z_2_9Proxi extends GradesInTenthProxi implements PersistentZ_2_9{
    
    public Z_2_9Proxi(long objectId) {
        super(objectId);
    }
    public Z_2_9Proxi(PersistentInCacheProxi object) {
        super(object);
    }
    ...
    public void deregister(final ObsInterface observee) 
        ...
        ((PersistentZ_2_9)this.getTheObject()).deregister(observee);
    }
    ...
    public void register(final ObsInterface observee) 
				throws PersistenceException{
        ((PersistentZ_2_9)this.getTheObject()).register(observee);
    }
    public void updateObservers(final model.meta.Mssgs event) 
				throws PersistenceException{
        ((PersistentZ_2_9)this.getTheObject()).updateObservers(event);
    }
