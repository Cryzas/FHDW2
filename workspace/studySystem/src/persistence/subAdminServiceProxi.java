...
public abstract class subAdminServiceProxi extends PersistentProxi implements PersistentsubAdminService{
    
    public subAdminServiceProxi(long objectId) {
        super(objectId);
    }
    public subAdminServiceProxi(PersistentInCacheProxi object) {
        super(object);
    }
