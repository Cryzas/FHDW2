...
public class Z_5_0ICProxi extends GradesInTenthICProxi implements PersistentZ_5_0{
    
    public Z_5_0ICProxi(long objectId) {
        super(objectId);
    }
    public Z_5_0ICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theZ_5_0Facade
            .getZ_5_0(this.getId());
    }
