...
public class T_1_3Proxi extends GradesInThirdProxi implements PersistentT_1_3{
    
    public T_1_3Proxi(long objectId) {
        super(objectId);
    }
    public T_1_3Proxi(PersistentInCacheProxi object) {
        super(object);
    }
    ...
    public void deregister(final ObsInterface observee) 
        ...
        ((PersistentT_1_3)this.getTheObject()).deregister(observee);
    }
    ...
    public void register(final ObsInterface observee) 
				throws PersistenceException{
        ((PersistentT_1_3)this.getTheObject()).register(observee);
    }
    public void updateObservers(final model.meta.Mssgs event) 
				throws PersistenceException{
        ((PersistentT_1_3)this.getTheObject()).updateObservers(event);
    }
    ...
    public common.Fraction toFraction() 
        ...
        return ((PersistentT_1_3)this.getTheObject()).toFraction();
    }
