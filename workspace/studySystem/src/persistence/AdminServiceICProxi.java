...
public class AdminServiceICProxi extends ServiceICProxi implements PersistentAdminService{
    
    public AdminServiceICProxi(long objectId) {
        super(objectId);
    }
    public AdminServiceICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theAdminServiceFacade
            .getAdminService(this.getId());
    }
