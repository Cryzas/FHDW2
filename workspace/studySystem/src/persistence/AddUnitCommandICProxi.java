...
public class AddUnitCommandICProxi extends PersistentInCacheProxi implements PersistentAddUnitCommand{
    
    public AddUnitCommandICProxi(long objectId) {
        super(objectId);
    }
    public AddUnitCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theAddUnitCommandFacade
            .getAddUnitCommand(this.getId());
    }
