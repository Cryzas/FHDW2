...
public class StartStudyGroupCommandProxi extends PersistentProxi implements PersistentStartStudyGroupCommand{
    
    public StartStudyGroupCommandProxi(long objectId) {
        super(objectId);
    }
    public StartStudyGroupCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
