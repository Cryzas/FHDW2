...
public class Z_2_1Proxi extends GradesInTenthProxi implements PersistentZ_2_1{
    ...
    public void deregister(final ObsInterface observee) 
        ...
        ((PersistentZ_2_1)this.getTheObject()).deregister(observee);
    }
    ...
    public void register(final ObsInterface observee) 
				throws PersistenceException{
        ((PersistentZ_2_1)this.getTheObject()).register(observee);
    }
    public void updateObservers(final model.meta.Mssgs event) 
				throws PersistenceException{
        ((PersistentZ_2_1)this.getTheObject()).updateObservers(event);
    }
