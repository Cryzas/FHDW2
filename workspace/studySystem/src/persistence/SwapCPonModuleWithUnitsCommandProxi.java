...
public class SwapCPonModuleWithUnitsCommandProxi extends PersistentProxi implements PersistentSwapCPonModuleWithUnitsCommand{
    
    public SwapCPonModuleWithUnitsCommandProxi(long objectId) {
        super(objectId);
    }
    public SwapCPonModuleWithUnitsCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
