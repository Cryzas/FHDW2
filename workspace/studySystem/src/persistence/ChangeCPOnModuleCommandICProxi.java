...
public class ChangeCPOnModuleCommandICProxi extends PersistentInCacheProxi implements PersistentChangeCPOnModuleCommand{
    
    public ChangeCPOnModuleCommandICProxi(long objectId) {
        super(objectId);
    }
    public ChangeCPOnModuleCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theChangeCPOnModuleCommandFacade
            .getChangeCPOnModuleCommand(this.getId());
    }
