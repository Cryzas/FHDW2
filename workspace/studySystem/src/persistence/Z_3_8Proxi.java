...
public class Z_3_8Proxi extends GradesInTenthProxi implements PersistentZ_3_8{
    
    public Z_3_8Proxi(long objectId) {
        super(objectId);
    }
    public Z_3_8Proxi(PersistentInCacheProxi object) {
        super(object);
    }
