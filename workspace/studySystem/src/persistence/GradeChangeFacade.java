...
public class GradeChangeFacade{
    ...
    public PersistentGradeChange newGradeChange(java.sql.Date dateOfChange,String comment,long idCreateIfLessZero) throws PersistenceException {
        ...
        try{
            ...
            callable.close();
            GradeChange result = new GradeChange(null,null,dateOfChange,comment,null,null,id);
    ...
    public GradeChange getGradeChange(long GradeChangeId) throws PersistenceException{
        try{
            ...
            if (obj.getLong(10) != 0)
                This = (PersistentGradeChange)PersistentProxi.createProxi(obj.getLong(10), obj.getLong(11));
    ...
    public void subServiceSet(long GradeChangeId, SubjInterface subServiceVal) throws PersistenceException {
        try{
            CallableStatement callable;
            callable = this.con.prepareCall("Begin " + this.schemaName + ".GrdChngFacade.sbSrvcSet(?, ?, ?); end;");
            callable.setLong(1, GradeChangeId);
