...
public class T_3_3ICProxi extends GradesInThirdICProxi implements PersistentT_3_3{
    
    public T_3_3ICProxi(long objectId) {
        super(objectId);
    }
    public T_3_3ICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theT_3_3Facade
            .getT_3_3(this.getId());
    }
    ...
    public void deregister(final ObsInterface observee) 
        ...
        ((PersistentT_3_3)this.getTheObject()).deregister(observee);
    }
    ...
    public void register(final ObsInterface observee) 
				throws PersistenceException{
        ((PersistentT_3_3)this.getTheObject()).register(observee);
    }
    public void updateObservers(final model.meta.Mssgs event) 
				throws PersistenceException{
        ((PersistentT_3_3)this.getTheObject()).updateObservers(event);
    }
