...
public class CreateModuleCommandICProxi extends PersistentInCacheProxi implements PersistentCreateModuleCommand{
    
    public CreateModuleCommandICProxi(long objectId) {
        super(objectId);
    }
    public CreateModuleCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theCreateModuleCommandFacade
            .getCreateModuleCommand(this.getId());
    }
