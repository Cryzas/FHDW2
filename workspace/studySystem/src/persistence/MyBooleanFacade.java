...
public class MyBooleanFacade{
	...
	public MyBooleanFacade(String schemaName, Connection con) {
    ...
    public void subServiceSet(long MyBooleanId, SubjInterface subServiceVal) throws PersistenceException {
        try{
            CallableStatement callable;
            callable = this.con.prepareCall("Begin " + this.schemaName + ".MBlnFacade.sbSrvcSet(?, ?, ?); end;");
            callable.setLong(1, MyBooleanId);
