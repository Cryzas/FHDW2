...
public class Z_3_6ICProxi extends GradesInTenthICProxi implements PersistentZ_3_6{
    
    public Z_3_6ICProxi(long objectId) {
        super(objectId);
    }
    public Z_3_6ICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theZ_3_6Facade
            .getZ_3_6(this.getId());
    }
    ...
    public void deregister(final ObsInterface observee) 
        ...
        ((PersistentZ_3_6)this.getTheObject()).deregister(observee);
    }
    ...
    public void register(final ObsInterface observee) 
				throws PersistenceException{
        ((PersistentZ_3_6)this.getTheObject()).register(observee);
    }
    public void updateObservers(final model.meta.Mssgs event) 
				throws PersistenceException{
        ((PersistentZ_3_6)this.getTheObject()).updateObservers(event);
    }
