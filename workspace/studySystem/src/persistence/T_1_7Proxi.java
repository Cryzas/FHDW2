...
public class T_1_7Proxi extends GradesInThirdProxi implements PersistentT_1_7{
    
    public T_1_7Proxi(long objectId) {
        super(objectId);
    }
    public T_1_7Proxi(PersistentInCacheProxi object) {
        super(object);
    }
