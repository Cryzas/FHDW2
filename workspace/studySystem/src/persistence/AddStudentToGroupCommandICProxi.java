...
public class AddStudentToGroupCommandICProxi extends PersistentInCacheProxi implements PersistentAddStudentToGroupCommand{
    
    public AddStudentToGroupCommandICProxi(long objectId) {
        super(objectId);
    }
    public AddStudentToGroupCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theAddStudentToGroupCommandFacade
            .getAddStudentToGroupCommand(this.getId());
    }
