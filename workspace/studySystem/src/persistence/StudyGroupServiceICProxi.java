...
public class StudyGroupServiceICProxi extends subAdminServiceICProxi implements PersistentStudyGroupService{
    
    public StudyGroupServiceICProxi(long objectId) {
        super(objectId);
    }
    public StudyGroupServiceICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theStudyGroupServiceFacade
            .getStudyGroupService(this.getId());
    }
