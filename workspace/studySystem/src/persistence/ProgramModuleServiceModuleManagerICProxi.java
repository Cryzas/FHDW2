...
public class ProgramModuleServiceModuleManagerICProxi extends PersistentInCacheProxiOptimistic implements PersistentProgramModuleServiceModuleManager{
    
    public ProgramModuleServiceModuleManagerICProxi(long objectId) {
        super(objectId);
    }
    public ProgramModuleServiceModuleManagerICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theProgramModuleServiceModuleManagerFacade
            .getProgramModuleServiceModuleManager(this.getId());
    }
