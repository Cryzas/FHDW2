...
public class Z_2_3ICProxi extends GradesInTenthICProxi implements PersistentZ_2_3{
    
    public Z_2_3ICProxi(long objectId) {
        super(objectId);
    }
    public Z_2_3ICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theZ_2_3Facade
            .getZ_2_3(this.getId());
    }
    ...
    public void deregister(final ObsInterface observee) 
        ...
        ((PersistentZ_2_3)this.getTheObject()).deregister(observee);
    }
    ...
    public void register(final ObsInterface observee) 
				throws PersistenceException{
        ((PersistentZ_2_3)this.getTheObject()).register(observee);
    }
    public void updateObservers(final model.meta.Mssgs event) 
				throws PersistenceException{
        ((PersistentZ_2_3)this.getTheObject()).updateObservers(event);
    }
