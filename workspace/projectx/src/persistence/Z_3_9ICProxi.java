...
public class Z_3_9ICProxi extends GradesInTenthICProxi implements PersistentZ_3_9{
    
    public Z_3_9ICProxi(long objectId) {
        super(objectId);
    }
    public Z_3_9ICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theZ_3_9Facade
            .getZ_3_9(this.getId());
    }
