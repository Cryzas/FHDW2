...
public class ChangeGradeOfModuleSimpleCommandICProxi extends PersistentInCacheProxi implements PersistentChangeGradeOfModuleSimpleCommand{
    
    public ChangeGradeOfModuleSimpleCommandICProxi(long objectId) {
        super(objectId);
    }
    public ChangeGradeOfModuleSimpleCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theChangeGradeOfModuleSimpleCommandFacade
            .getChangeGradeOfModuleSimpleCommand(this.getId());
    }
