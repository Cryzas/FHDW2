...
public class AddModuleToProgCommandICProxi extends PersistentInCacheProxi implements PersistentAddModuleToProgCommand{
    
    public AddModuleToProgCommandICProxi(long objectId) {
        super(objectId);
    }
    public AddModuleToProgCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theAddModuleToProgCommandFacade
            .getAddModuleToProgCommand(this.getId());
    }
