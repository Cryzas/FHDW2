...
public class ChangeGradeOfUnitCommandProxi extends PersistentProxi implements PersistentChangeGradeOfUnitCommand{
    
    public ChangeGradeOfUnitCommandProxi(long objectId) {
        super(objectId);
    }
    public ChangeGradeOfUnitCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
