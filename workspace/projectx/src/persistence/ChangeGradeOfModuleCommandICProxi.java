...
public class ChangeGradeOfModuleCommandICProxi extends PersistentInCacheProxi implements PersistentChangeGradeOfModuleCommand{
    
    public ChangeGradeOfModuleCommandICProxi(long objectId) {
        super(objectId);
    }
    public ChangeGradeOfModuleCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theChangeGradeOfModuleCommandFacade
            .getChangeGradeOfModuleCommand(this.getId());
    }
