...
public class ModuleWithUnitsSGroupICProxi extends ModuleAbstractSGroupICProxi implements PersistentModuleWithUnitsSGroup{
    
    public ModuleWithUnitsSGroupICProxi(long objectId) {
        super(objectId);
    }
    public ModuleWithUnitsSGroupICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theModuleWithUnitsSGroupFacade
            .getModuleWithUnitsSGroup(this.getId());
    }
