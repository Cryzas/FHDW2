...
public class NoGradeThirdICProxi extends GradesInThirdICProxi implements PersistentNoGradeThird{
    
    public NoGradeThirdICProxi(long objectId) {
        super(objectId);
    }
    public NoGradeThirdICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theNoGradeThirdFacade
            .getNoGradeThird(this.getId());
    }
