...
public class ModuleGroupSGroupProxi extends ModuleAbstractSGroupProxi implements PersistentModuleGroupSGroup{
    
    public ModuleGroupSGroupProxi(long objectId) {
        super(objectId);
    }
    public ModuleGroupSGroupProxi(PersistentInCacheProxi object) {
        super(object);
    }
