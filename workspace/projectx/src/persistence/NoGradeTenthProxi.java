...
public class NoGradeTenthProxi extends GradesInTenthProxi implements PersistentNoGradeTenth{
    
    public NoGradeTenthProxi(long objectId) {
        super(objectId);
    }
    public NoGradeTenthProxi(PersistentInCacheProxi object) {
        super(object);
    }
