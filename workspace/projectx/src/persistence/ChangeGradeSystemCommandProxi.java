...
public class ChangeGradeSystemCommandProxi extends PersistentProxi implements PersistentChangeGradeSystemCommand{
    
    public ChangeGradeSystemCommandProxi(long objectId) {
        super(objectId);
    }
    public ChangeGradeSystemCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
