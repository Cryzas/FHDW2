...
public class ProgramManagerFacade{
    ...
    public PersistentProgramManager newProgramManager(long idCreateIfLessZero) throws PersistenceException {
        ...
        try{
            ...
            callable.close();
            ProgramManager result = new ProgramManager(null,id);
    ...
    public ProgramManager getProgramManager(long ProgramManagerId) throws PersistenceException{
        try{
            ...
            if (obj.getLong(2) != 0)
                This = (PersistentProgramManager)PersistentProxi.createProxi(obj.getLong(2), obj.getLong(3));
            ProgramManager result = new ProgramManager(This,
                                                       ProgramManagerId);
            obj.close();
            callable.close();
