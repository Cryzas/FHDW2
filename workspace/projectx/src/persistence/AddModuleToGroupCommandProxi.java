...
public class AddModuleToGroupCommandProxi extends PersistentProxi implements PersistentAddModuleToGroupCommand{
    
    public AddModuleToGroupCommandProxi(long objectId) {
        super(objectId);
    }
    public AddModuleToGroupCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
