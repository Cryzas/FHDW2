...
public class StudentManagerFacade{
    ...
    public PersistentStudentManager newStudentManager(long idCreateIfLessZero) throws PersistenceException {
        ...
        try{
            ...
            callable.close();
            StudentManager result = new StudentManager(null,id);
    ...
    public StudentManager getStudentManager(long StudentManagerId) throws PersistenceException{
        try{
            ...
            if (obj.getLong(2) != 0)
                This = (PersistentStudentManager)PersistentProxi.createProxi(obj.getLong(2), obj.getLong(3));
            StudentManager result = new StudentManager(This,
                                                       StudentManagerId);
            obj.close();
            callable.close();
