...
public class Z_2_7ICProxi extends GradesInTenthICProxi implements PersistentZ_2_7{
    
    public Z_2_7ICProxi(long objectId) {
        super(objectId);
    }
    public Z_2_7ICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theZ_2_7Facade
            .getZ_2_7(this.getId());
    }
