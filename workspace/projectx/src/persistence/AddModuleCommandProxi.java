...
public class AddModuleCommandProxi extends PersistentProxi implements PersistentAddModuleCommand{
    
    public AddModuleCommandProxi(long objectId) {
        super(objectId);
    }
    public AddModuleCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
