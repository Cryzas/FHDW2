...
public class ChangeCPOnUnitCommandICProxi extends PersistentInCacheProxi implements PersistentChangeCPOnUnitCommand{
    
    public ChangeCPOnUnitCommandICProxi(long objectId) {
        super(objectId);
    }
    public ChangeCPOnUnitCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theChangeCPOnUnitCommandFacade
            .getChangeCPOnUnitCommand(this.getId());
    }
