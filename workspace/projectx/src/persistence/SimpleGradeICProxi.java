...
public class SimpleGradeICProxi extends GradeSystemICProxi implements PersistentSimpleGrade{
    
    public SimpleGradeICProxi(long objectId) {
        super(objectId);
    }
    public SimpleGradeICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theSimpleGradeFacade
            .getSimpleGrade(this.getId());
    }
