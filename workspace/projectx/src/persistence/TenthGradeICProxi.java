...
public class TenthGradeICProxi extends GradeSystemICProxi implements PersistentTenthGrade{
    
    public TenthGradeICProxi(long objectId) {
        super(objectId);
    }
    public TenthGradeICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theTenthGradeFacade
            .getTenthGrade(this.getId());
    }
