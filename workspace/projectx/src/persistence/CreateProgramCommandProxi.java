...
public class CreateProgramCommandProxi extends PersistentProxi implements PersistentCreateProgramCommand{
    
    public CreateProgramCommandProxi(long objectId) {
        super(objectId);
    }
    public CreateProgramCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
