...
public class ChangeGradeOfModuleThirdCommandProxi extends PersistentProxi implements PersistentChangeGradeOfModuleThirdCommand{
    
    public ChangeGradeOfModuleThirdCommandProxi(long objectId) {
        super(objectId);
    }
    public ChangeGradeOfModuleThirdCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
