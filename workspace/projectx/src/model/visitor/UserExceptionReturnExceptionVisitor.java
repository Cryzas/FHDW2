...
public interface UserExceptionReturnExceptionVisitor<R, E extends model.UserException> {
    ...
    public R handleAlreadyFinishedException(model.AlreadyFinishedException alreadyFinishedException) throws PersistenceException, E;
    ...
    public R handleNoFractionValueException(model.NoFractionValueException noFractionValueException) throws PersistenceException, E;
