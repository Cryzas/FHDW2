...
public interface programHierarchyStudentHIERARCHYReturnExceptionVisitor<R, E extends model.UserException> extends ModuleAbstractStudentReturnExceptionVisitor<R, E> {
