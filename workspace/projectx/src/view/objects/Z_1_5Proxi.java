...
public class Z_1_5Proxi extends GradesInTenthProxi implements Z_1_5View{
    
    public Z_1_5Proxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public Z_1_5View getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        Z_1_5View result$$ = new Z_1_5( this.getId(), this.getClassId());
