...
public abstract class ViewRoot extends ViewObjectInTree implements TableModel, TreeModel {
	...
	protected static String DATEFORMAT = DateAndTime.DATEFORMAT;
	protected static String TIMESTAMPFORMAT = DateAndTime.TIMESTAMPFORMAT;
	
	protected static String toString(java.util.Date date, boolean doWithMillies){
		return DateAndTime.toString(date, doWithMillies);
	}
	...
	public javafx.scene.image.Image getImage(){
		return viewClient.IconManager.getImage(this.getIconInfo());
	}	
}
