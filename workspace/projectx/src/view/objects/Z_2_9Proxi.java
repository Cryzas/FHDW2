...
public class Z_2_9Proxi extends GradesInTenthProxi implements Z_2_9View{
    
    public Z_2_9Proxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public Z_2_9View getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        Z_2_9View result$$ = new Z_2_9( this.getId(), this.getClassId());
