...
public class Z_3_7Proxi extends GradesInTenthProxi implements Z_3_7View{
    
    public Z_3_7Proxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public Z_3_7View getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        Z_3_7View result$$ = new Z_3_7( this.getId(), this.getClassId());
