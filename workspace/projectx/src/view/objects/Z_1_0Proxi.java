...
public class Z_1_0Proxi extends GradesInTenthProxi implements Z_1_0View{
    
    public Z_1_0Proxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public Z_1_0View getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        Z_1_0View result$$ = new Z_1_0( this.getId(), this.getClassId());
