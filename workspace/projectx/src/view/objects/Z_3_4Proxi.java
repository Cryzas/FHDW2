...
public class Z_3_4Proxi extends GradesInTenthProxi implements Z_3_4View{
    
    public Z_3_4Proxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public Z_3_4View getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        Z_3_4View result$$ = new Z_3_4( this.getId(), this.getClassId());
