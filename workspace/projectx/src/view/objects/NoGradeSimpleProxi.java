...
public class NoGradeSimpleProxi extends GradesInSimpleProxi implements NoGradeSimpleView{
    
    public NoGradeSimpleProxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public NoGradeSimpleView getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        NoGradeSimpleView result$$ = new NoGradeSimple( this.getId(), this.getClassId());
