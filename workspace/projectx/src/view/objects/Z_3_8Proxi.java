...
public class Z_3_8Proxi extends GradesInTenthProxi implements Z_3_8View{
    
    public Z_3_8Proxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public Z_3_8View getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        Z_3_8View result$$ = new Z_3_8( this.getId(), this.getClassId());
