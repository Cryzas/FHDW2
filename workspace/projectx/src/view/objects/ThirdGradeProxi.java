...
public class ThirdGradeProxi extends GradeSystemProxi implements ThirdGradeView{
    
    public ThirdGradeProxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public ThirdGradeView getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        ThirdGradeView result$$ = new ThirdGrade( this.getId(), this.getClassId());
