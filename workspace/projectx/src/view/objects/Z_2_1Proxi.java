...
public class Z_2_1Proxi extends GradesInTenthProxi implements Z_2_1View{
    
    public Z_2_1Proxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public Z_2_1View getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        Z_2_1View result$$ = new Z_2_1( this.getId(), this.getClassId());
