...
public class NotPassedProxi extends GradesInSimpleProxi implements NotPassedView{
    
    public NotPassedProxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public NotPassedView getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        NotPassedView result$$ = new NotPassed( this.getId(), this.getClassId());
