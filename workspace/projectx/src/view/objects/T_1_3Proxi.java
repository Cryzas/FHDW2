...
public class T_1_3Proxi extends GradesInThirdProxi implements T_1_3View{
    
    public T_1_3Proxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public T_1_3View getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        T_1_3View result$$ = new T_1_3( this.getId(), this.getClassId());
