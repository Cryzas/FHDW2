...
public class T_3_0Proxi extends GradesInThirdProxi implements T_3_0View{
    
    public T_3_0Proxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public T_3_0View getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        T_3_0View result$$ = new T_3_0( this.getId(), this.getClassId());
