...
public class Z_2_3Proxi extends GradesInTenthProxi implements Z_2_3View{
    
    public Z_2_3Proxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public Z_2_3View getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        Z_2_3View result$$ = new Z_2_3( this.getId(), this.getClassId());
