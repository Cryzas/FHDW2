...
public class Z_1_1Proxi extends GradesInTenthProxi implements Z_1_1View{
    
    public Z_1_1Proxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public Z_1_1View getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        Z_1_1View result$$ = new Z_1_1( this.getId(), this.getClassId());
