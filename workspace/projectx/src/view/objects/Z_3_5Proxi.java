...
public class Z_3_5Proxi extends GradesInTenthProxi implements Z_3_5View{
    
    public Z_3_5Proxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public Z_3_5View getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        Z_3_5View result$$ = new Z_3_5( this.getId(), this.getClassId());
