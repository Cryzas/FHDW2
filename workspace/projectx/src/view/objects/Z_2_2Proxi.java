...
public class Z_2_2Proxi extends GradesInTenthProxi implements Z_2_2View{
    
    public Z_2_2Proxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public Z_2_2View getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        Z_2_2View result$$ = new Z_2_2( this.getId(), this.getClassId());
