...
public class T_4_0Proxi extends GradesInThirdProxi implements T_4_0View{
    
    public T_4_0Proxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public T_4_0View getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        T_4_0View result$$ = new T_4_0( this.getId(), this.getClassId());
