...
public class Z_1_4Proxi extends GradesInTenthProxi implements Z_1_4View{
    
    public Z_1_4Proxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public Z_1_4View getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        Z_1_4View result$$ = new Z_1_4( this.getId(), this.getClassId());
