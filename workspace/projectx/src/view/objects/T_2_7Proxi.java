...
public class T_2_7Proxi extends GradesInThirdProxi implements T_2_7View{
    
    public T_2_7Proxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public T_2_7View getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        T_2_7View result$$ = new T_2_7( this.getId(), this.getClassId());
