...
public interface AnythingReturnVisitor<R> extends GradeSystemReturnVisitor<R> ,GradesInSimpleOrThirdReturnVisitor<R> ,GradesInTenthReturnVisitor<R> ,ModuleAbstractReturnVisitor<R> ,ModuleAbstractSGroupReturnVisitor<R> ,ModuleAbstractStudentReturnVisitor<R> {
