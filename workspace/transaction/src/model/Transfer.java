...
public class Transfer extends model.AbstractTransfer implements PersistentTransfer{
    ...
    public Transfer(String subject,PersistentTransferState state,SubjInterface subService,PersistentAbstractTransfer This,PersistentAccount fromAccount,PersistentAccount toAccount,common.Fraction amount,long id) throws PersistenceException {
        /* Shall not be used by clients for object construction! Use static create operation instead! */
        super((String)subject,(PersistentTransferState)state,(SubjInterface)subService,(PersistentAbstractTransfer)This,id);
