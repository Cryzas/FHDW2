...
public interface AnythingReturnExceptionVisitor<R, E extends model.UserException> extends AbstractTransferReturnExceptionVisitor<R, E> ,AccountHandleReturnExceptionVisitor<R, E> ,CommonDateReturnExceptionVisitor<R, E> ,EntryReturnExceptionVisitor<R, E> {
