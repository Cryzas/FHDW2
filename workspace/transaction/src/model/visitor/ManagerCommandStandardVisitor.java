...
public abstract class ManagerCommandStandardVisitor implements ManagerCommandVisitor {
    ...
    protected abstract void standardHandling(ManagerCommand managerCommand) throws PersistenceException;
}
