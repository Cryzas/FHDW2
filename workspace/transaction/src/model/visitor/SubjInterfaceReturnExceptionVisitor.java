...
public interface SubjInterfaceReturnExceptionVisitor<R, E extends model.UserException> extends AbstractTransferReturnExceptionVisitor<R, E> ,AccountHandleReturnExceptionVisitor<R, E> ,EntryReturnExceptionVisitor<R, E> ,TransferStateReturnExceptionVisitor<R, E> {
