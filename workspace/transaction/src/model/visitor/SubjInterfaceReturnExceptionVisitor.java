...
public interface SubjInterfaceReturnExceptionVisitor<R, E extends model.UserException> extends AccountHandleReturnExceptionVisitor<R, E> ,BookableReturnExceptionVisitor<R, E> ,EntryReturnExceptionVisitor<R, E> {
