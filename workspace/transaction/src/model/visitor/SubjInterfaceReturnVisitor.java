...
public interface SubjInterfaceReturnVisitor<R> extends AbstractTransferReturnVisitor<R> ,AccountHandleReturnVisitor<R> ,EntryReturnVisitor<R> ,TransferStateReturnVisitor<R> {
