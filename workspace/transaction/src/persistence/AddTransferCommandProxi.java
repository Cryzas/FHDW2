...
public class AddTransferCommandProxi extends PersistentProxi implements PersistentAddTransferCommand{
    
    public AddTransferCommandProxi(long objectId) {
        super(objectId);
    }
    public AddTransferCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
