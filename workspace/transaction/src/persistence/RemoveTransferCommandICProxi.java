...
public class RemoveTransferCommandICProxi extends PersistentInCacheProxi implements PersistentRemoveTransferCommand{
    
    public RemoveTransferCommandICProxi(long objectId) {
        super(objectId);
    }
    public RemoveTransferCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theRemoveTransferCommandFacade
            .getRemoveTransferCommand(this.getId());
    }
