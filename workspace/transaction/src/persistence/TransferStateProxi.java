...
public abstract class TransferStateProxi extends PersistentProxi implements PersistentTransferState{
    
    public TransferStateProxi(long objectId) {
        super(objectId);
    }
    public TransferStateProxi(PersistentInCacheProxi object) {
        super(object);
    }
