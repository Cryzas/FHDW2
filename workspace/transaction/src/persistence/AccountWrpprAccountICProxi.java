...
public class AccountWrpprAccountICProxi extends PersistentInCacheProxiOptimistic implements PersistentAccountWrpprAccount{
    
    public AccountWrpprAccountICProxi(long objectId) {
        super(objectId);
    }
    public AccountWrpprAccountICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theAccountWrpprAccountFacade
            .getAccountWrpprAccount(this.getId());
    }
