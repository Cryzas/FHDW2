...
public class TransferManagerICProxi extends PersistentInCacheProxiOptimistic implements PersistentTransferManager{
    
    public TransferManagerICProxi(long objectId) {
        super(objectId);
    }
    public TransferManagerICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theTransferManagerFacade
            .getTransferManager(this.getId());
    }
