...
public class NoAccountICProxi extends AccountICProxi implements PersistentNoAccount{
    
    public NoAccountICProxi(long objectId) {
        super(objectId);
    }
    public NoAccountICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theNoAccountFacade
            .getNoAccount(this.getId());
    }
