...
public class CreateTransactionCommandProxi extends PersistentProxi implements PersistentCreateTransactionCommand{
    
    public CreateTransactionCommandProxi(long objectId) {
        super(objectId);
    }
    public CreateTransactionCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
