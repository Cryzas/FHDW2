...
public abstract class AccountHandleICProxi extends PersistentInCacheProxiOptimistic implements PersistentAccountHandle{
    
    public AccountHandleICProxi(long objectId) {
        super(objectId);
    }
    public AccountHandleICProxi(PersistentObject object) {
        super(object);
    }
