...
public class BookCommandProxi extends PersistentProxi implements PersistentBookCommand{
    
    public BookCommandProxi(long objectId) {
        super(objectId);
    }
    public BookCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
