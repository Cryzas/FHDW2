...
public class BookedICProxi extends TransferStateICProxi implements PersistentBooked{
    
    public BookedICProxi(long objectId) {
        super(objectId);
    }
    public BookedICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theBookedFacade
            .getBooked(this.getId());
    }
