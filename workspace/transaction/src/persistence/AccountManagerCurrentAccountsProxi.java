...
public class AccountManagerCurrentAccountsProxi extends PersistentProxi implements PersistentAccountManagerCurrentAccounts{
    
    public AccountManagerCurrentAccountsProxi(long objectId) {
        super(objectId);
    }
    public AccountManagerCurrentAccountsProxi(PersistentInCacheProxi object) {
        super(object);
    }
