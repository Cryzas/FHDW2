...
public class NotBookedProxi extends TransferStateProxi implements PersistentNotBooked{
    
    public NotBookedProxi(long objectId) {
        super(objectId);
    }
    public NotBookedProxi(PersistentInCacheProxi object) {
        super(object);
    }
