...
public class CreateTransferCommandProxi extends PersistentProxi implements PersistentCreateTransferCommand{
    
    public CreateTransferCommandProxi(long objectId) {
        super(objectId);
    }
    public CreateTransferCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
