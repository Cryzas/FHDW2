...
public class WrapperRecycleProxi extends PersistentProxi implements PersistentWrapperRecycle{
    
    public WrapperRecycleProxi(long objectId) {
        super(objectId);
    }
    public WrapperRecycleProxi(PersistentInCacheProxi object) {
        super(object);
    }
