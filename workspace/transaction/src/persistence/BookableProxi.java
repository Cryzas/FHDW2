...
public abstract class BookableProxi extends PersistentProxi implements PersistentBookable{
    
    public BookableProxi(long objectId) {
        super(objectId);
    }
    public BookableProxi(PersistentInCacheProxi object) {
        super(object);
    }
