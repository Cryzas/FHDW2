...
public class ServerAccountsICProxi extends PersistentInCacheProxiOptimistic implements PersistentServerAccounts{
    
    public ServerAccountsICProxi(long objectId) {
        super(objectId);
    }
    public ServerAccountsICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theServerAccountsFacade
            .getServerAccounts(this.getId());
    }
