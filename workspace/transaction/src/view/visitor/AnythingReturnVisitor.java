...
public interface AnythingReturnVisitor<R> extends AbstractTransferReturnVisitor<R> ,AccountHandleReturnVisitor<R> ,EntryReturnVisitor<R> ,TransferStateReturnVisitor<R> {
    ...
    public R handleWrapperRecycle(WrapperRecycleView wrapperRecycle) throws ModelException;
