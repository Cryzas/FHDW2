...
public interface AnythingExceptionVisitor<E extends view.UserException> extends AbstractTransferExceptionVisitor<E>,AccountHandleExceptionVisitor<E>,EntryExceptionVisitor<E>,TransferStateExceptionVisitor<E>{
    ...
    public void handleWrapperRecycle(WrapperRecycleView wrapperRecycle) throws ModelException, E;
