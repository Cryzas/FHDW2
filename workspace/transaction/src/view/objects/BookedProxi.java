...
public class BookedProxi extends TransferStateProxi implements BookedView{
    
    public BookedProxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public BookedView getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        BookedView result$$ = new Booked( this.getId(), this.getClassId());
