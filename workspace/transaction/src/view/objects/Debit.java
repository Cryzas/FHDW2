...
public class Debit extends view.objects.Entry implements DebitView{
    
    
    public Debit(String description,common.Fraction amount,AccountView otherAcc,long id, long classId) {
