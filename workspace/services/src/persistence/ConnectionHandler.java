...
public class ConnectionHandler {
    ...
    public RegisterFacade theRegisterFacade;
    public UserManagerFacade theUserManagerFacade;
...
//			oracleConnection.setImplicitCachingEnabled(true);
            ...
            this.theCustomerFacade= new CustomerFacade(this.schemaName, this.con);
            this.theRegisterFacade= new RegisterFacade(this.schemaName, this.con);
            this.theUserManagerFacade= new UserManagerFacade(this.schemaName, this.con);
