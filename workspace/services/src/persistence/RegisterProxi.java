...
public class RegisterProxi extends ServiceProxi implements PersistentRegister{
    
    public RegisterProxi(long objectId) {
        super(objectId);
    }
    public RegisterProxi(PersistentInCacheProxi object) {
        super(object);
    }
