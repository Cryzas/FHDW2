...
public class UserManagerProxi extends ServiceProxi implements PersistentUserManager{
    
    public UserManagerProxi(long objectId) {
        super(objectId);
    }
    public UserManagerProxi(PersistentInCacheProxi object) {
        super(object);
    }
