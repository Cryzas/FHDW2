...
class DetailPanelFactory implements AnythingVisitor {
    ...
    public void handleRegister(view.RegisterView object){
        result = new RegisterDefaultDetailPanel(handler, object);
    }
    public void handleUserManager(view.UserManagerView object){
        result = new UserManagerDefaultDetailPanel(handler, object);
    }
...
class RegisterDefaultDetailPanel extends DefaultDetailPanel{
    
    protected RegisterDefaultDetailPanel(ExceptionAndEventHandler exceptionHandler, Anything anything) {
        super(exceptionHandler, anything);
    }
    protected void addFields(){
        
    }
    protected view.RegisterView getAnything(){
        return (view.RegisterView)this.anything;
    }
}
...
class UserManagerDefaultDetailPanel extends DefaultDetailPanel{
    ...
    protected view.UserManagerView getAnything(){
        return (view.UserManagerView)this.anything;
    }
}
