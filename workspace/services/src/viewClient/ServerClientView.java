			...
			while (serviceIterator.hasNext()) {
				...
				current.accept(new ServiceVisitor() {
					...
					public void handleUserManager(UserManagerView userManager) throws ModelException {
						UserManagerClientView view = new UserManagerClientView(ServerClientView.this, userManager);
						userManager.connectUserManager(ServerClientView.this.getConnection(), view);
						Tab newTab = new Tab(userManager.toString(), view);
					...
					public void handleCustomer(CustomerView customer) throws ModelException {
						...
						Tab newTab = new Tab(customer.toString(), view);
						getMainTabPane().getTabs().add(newTab);
					...
					public void handleAdministrator(AdministratorView administrator) throws ModelException {
						...
						Tab newTab = new Tab(administrator.toString(), view);
						getMainTabPane().getTabs().add(newTab);
					...
					public void handleRegister(RegisterView register) throws ModelException {
						RegisterClientView view = new RegisterClientView(ServerClientView.this, register);
						register.connectRegister(ServerClientView.this.getConnection(), view);
						Tab newTab = new Tab(register.toString(), view);
						getMainTabPane().getTabs().add(newTab);
					}
				});
			}
