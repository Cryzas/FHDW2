...
public class AddPartCommandProxi extends PersistentProxi implements PersistentAddPartCommand{
    
    public AddPartCommandProxi(long objectId) {
        super(objectId);
    }
    public AddPartCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
