...
public class ConnectionHandler {
    ...
    public CreateMaterialCommandFacade theCreateMaterialCommandFacade;
    public AddPartCommandFacade theAddPartCommandFacade;
    public ComponentLstFacade theComponentLstFacade;
    public CreateProductCommandFacade theCreateProductCommandFacade;
...
//			oracleConnection.setImplicitCachingEnabled(true);
            ...
            this.theCreateMaterialCommandFacade= new CreateMaterialCommandFacade(this.schemaName, this.con);
            this.theAddPartCommandFacade= new AddPartCommandFacade(this.schemaName, this.con);
            this.theComponentLstFacade= new ComponentLstFacade(this.schemaName, this.con);
            this.theCreateProductCommandFacade= new CreateProductCommandFacade(this.schemaName, this.con);
