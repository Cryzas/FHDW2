...
public class PartsListManagerProxi extends PersistentProxi implements PersistentPartsListManager{
    
    public PartsListManagerProxi(long objectId) {
        super(objectId);
    }
    public PartsListManagerProxi(PersistentInCacheProxi object) {
        super(object);
    }
