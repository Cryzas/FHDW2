...
public class CreateMaterialCommandICProxi extends PersistentInCacheProxi implements PersistentCreateMaterialCommand{
    
    public CreateMaterialCommandICProxi(long objectId) {
        super(objectId);
    }
    public CreateMaterialCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theCreateMaterialCommandFacade
            .getCreateMaterialCommand(this.getId());
    }
