...
public class CreateProductCommandProxi extends PersistentProxi implements PersistentCreateProductCommand{
    
    public CreateProductCommandProxi(long objectId) {
        super(objectId);
    }
    public CreateProductCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
