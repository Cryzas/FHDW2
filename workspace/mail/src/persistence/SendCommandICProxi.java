...
public class SendCommandICProxi extends PersistentInCacheProxi implements PersistentSendCommand{
    
    public SendCommandICProxi(long objectId) {
        super(objectId);
    }
    public SendCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theSendCommandFacade
            .getSendCommand(this.getId());
    }
