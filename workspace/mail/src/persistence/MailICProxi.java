...
public abstract class MailICProxi extends PersistentInCacheProxiOptimistic implements PersistentMail{
    
    public MailICProxi(long objectId) {
        super(objectId);
    }
    public MailICProxi(PersistentObject object) {
        super(object);
    }
