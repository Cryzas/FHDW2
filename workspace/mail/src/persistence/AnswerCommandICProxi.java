...
public class AnswerCommandICProxi extends PersistentInCacheProxi implements PersistentAnswerCommand{
    
    public AnswerCommandICProxi(long objectId) {
        super(objectId);
    }
    public AnswerCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theAnswerCommandFacade
            .getAnswerCommand(this.getId());
    }
