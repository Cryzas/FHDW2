...
public class AccountWrapperProxi extends abstractAccProxi implements PersistentAccountWrapper{
    
    public AccountWrapperProxi(long objectId) {
        super(objectId);
    }
    public AccountWrapperProxi(PersistentInCacheProxi object) {
        super(object);
    }
