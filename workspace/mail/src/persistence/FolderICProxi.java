...
public class FolderICProxi extends PersistentInCacheProxiOptimistic implements PersistentFolder{
    
    public FolderICProxi(long objectId) {
        super(objectId);
    }
    public FolderICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theFolderFacade
            .getFolder(this.getId());
    }
