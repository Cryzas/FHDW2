...
public class CreateDraftCommandProxi extends PersistentProxi implements PersistentCreateDraftCommand{
    
    public CreateDraftCommandProxi(long objectId) {
        super(objectId);
    }
    public CreateDraftCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
