...
public class CreateFolderCommandProxi extends PersistentProxi implements PersistentCreateFolderCommand{
    
    public CreateFolderCommandProxi(long objectId) {
        super(objectId);
    }
    public CreateFolderCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
