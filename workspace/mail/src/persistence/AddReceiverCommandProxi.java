...
public class AddReceiverCommandProxi extends PersistentProxi implements PersistentAddReceiverCommand{
    
    public AddReceiverCommandProxi(long objectId) {
        super(objectId);
    }
    public AddReceiverCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
