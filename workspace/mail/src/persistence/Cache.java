...
/* ********************* Cache report ********************** */	
	...
	private void initializeNumber2NameMap() {
		...
		this.number2NameMap.put(119, "Account");
		...
		this.number2NameMap.put(126, "CreateAccountCommand");
		this.number2NameMap.put(135, "CreateDraftCommand");
		this.number2NameMap.put(122, "CreateFolderCommand");
		this.number2NameMap.put(133, "Draft");
		this.number2NameMap.put(-120, "ErrorDisplay");
		this.number2NameMap.put(121, "Folder");
		this.number2NameMap.put(134, "MailEntry");
		this.number2NameMap.put(124, "SendCommand");
