...
public class AnswerAllCommandProxi extends PersistentProxi implements PersistentAnswerAllCommand{
    
    public AnswerAllCommandProxi(long objectId) {
        super(objectId);
    }
    public AnswerAllCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
