...
public abstract class abstractAccProxi extends PersistentProxi implements PersistentabstractAcc{
    
    public abstractAccProxi(long objectId) {
        super(objectId);
    }
    public abstractAccProxi(PersistentInCacheProxi object) {
        super(object);
    }
