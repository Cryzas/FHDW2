...
public class ServerFacade{
    ...
    public Server getServer(long ServerId) throws PersistenceException{
        try{
            ...
            PersistentAccountManager manager = null;
            if (obj.getLong(2) != 0)
                manager = (PersistentAccountManager)PersistentProxi.createProxi(obj.getLong(2), obj.getLong(3));
    ...
    public void managerSet(long ServerId, AccountManager4Public managerVal) throws PersistenceException {
        try{
            CallableStatement callable;
