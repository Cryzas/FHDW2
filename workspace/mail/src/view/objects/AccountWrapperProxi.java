...
public class AccountWrapperProxi extends abstractAccProxi implements AccountWrapperView{
    
    public AccountWrapperProxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public AccountWrapperView getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        String name = (String)resultTable.get("name");
        AccountWrapperView result$$ = new AccountWrapper((String)name, this.getId(), this.getClassId());
