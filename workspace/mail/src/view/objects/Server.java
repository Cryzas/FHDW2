...
public class Server extends ViewObject implements ServerView{
    ...
    protected AccountManagerView manager;
    protected java.util.Vector<ErrorDisplayView> errors;
    protected String user;
    
    public Server(AccountManagerView manager,java.util.Vector<ErrorDisplayView> errors,String user,long id, long classId) {
    ...
    public AccountManagerView getManager()throws ModelException{
        return this.manager;
    }
    public void setManager(AccountManagerView newValue) throws ModelException {
    ...
    public void resolveProxies(java.util.HashMap<String,Object> resultTable) throws ModelException {
        AccountManagerView manager = this.getManager();
        if (manager != null) {
