  ...
  private static ProxiFactory [] getTheProxiFactories(){
	if (proxiFactories == null){
        ...
        proxiFactories[20] = new ProxiFactory(){
            ViewProxi create(long objectId, long classId, ExceptionAndEventHandler connectionKey){
                return new FolderProxi(objectId, classId, connectionKey);
            }
        };
        proxiFactories[38] = new ProxiFactory(){
            ViewProxi create(long objectId, long classId, ExceptionAndEventHandler connectionKey){
                return new AccountWrapperProxi(objectId, classId, connectionKey);
            }
        };
        proxiFactories[32] = new ProxiFactory(){
            ViewProxi create(long objectId, long classId, ExceptionAndEventHandler connectionKey){
                return new DraftProxi(objectId, classId, connectionKey);
            }
        };
        ...
        proxiFactories[33] = new ProxiFactory(){
            ViewProxi create(long objectId, long classId, ExceptionAndEventHandler connectionKey){
                return new MailEntryProxi(objectId, classId, connectionKey);
            }
        };
	}
