...
class DetailPanelFactory implements AnythingVisitor {
    ...
    public void handleFolder(view.FolderView object){
        result = new FolderDefaultDetailPanel(handler, object);
    }
    public void handleAccountWrapper(view.AccountWrapperView object){
        result = new AccountWrapperDefaultDetailPanel(handler, object);
    }
    public void handleDraft(view.DraftView object){
        result = new DraftDefaultDetailPanel(handler, object);
    }
    ...
    public void handleMailEntry(view.MailEntryView object){
        result = new MailEntryDefaultDetailPanel(handler, object);
    }
...
class AccountDefaultDetailPanel extends DefaultDetailPanel{
    ...
    protected static final String abstractAcc$$name = "abstractAcc$$name";
    protected static final String Account$$InBox = "Account$$InBox";
    protected static final String Account$$OutBox = "Account$$OutBox";
    protected static final String Account$$drafts = "Account$$drafts";
    protected static final String Account$$folders = "Account$$folders";
    ...
    protected void addFields(){
        try{
            ...
            this.panels.put(abstractAcc$$name, panel);
        }catch(ModelException e){
...
class FolderDefaultDetailPanel extends DefaultDetailPanel{
    
    protected static final String Folder$$name = "Folder$$name";
    protected static final String Folder$$mails = "Folder$$mails";
    
    protected FolderDefaultDetailPanel(ExceptionAndEventHandler exceptionHandler, Anything anything) {
        super(exceptionHandler, anything);
    }
    protected void addFields(){
        try{
            BaseTypePanel panel = new StringPanel(this, "name", this.getAnything().getName());
            this.getScrollablePane().getChildren().add(panel);
            this.panels.put(Folder$$name, panel);
        }catch(ModelException e){
            this.getExceptionAndEventhandler().handleException(e);
        }
        
    }
    protected view.FolderView getAnything(){
        return (view.FolderView)this.anything;
    }
}

class AccountWrapperDefaultDetailPanel extends DefaultDetailPanel{
    
    protected static final String abstractAcc$$name = "abstractAcc$$name";
    
    protected AccountWrapperDefaultDetailPanel(ExceptionAndEventHandler exceptionHandler, Anything anything) {
        super(exceptionHandler, anything);
    }
    protected void addFields(){
        try{
    ...
    protected view.AccountWrapperView getAnything(){
        return (view.AccountWrapperView)this.anything;
    }
}

class DraftDefaultDetailPanel extends DefaultDetailPanel{
    
    protected static final String Mail$$receivers = "Mail$$receivers";
    protected static final String Mail$$subject = "Mail$$subject";
    protected static final String Mail$$text = "Mail$$text";
    
    protected DraftDefaultDetailPanel(ExceptionAndEventHandler exceptionHandler, Anything anything) {
        super(exceptionHandler, anything);
    }
    protected void addFields(){
        try{
            ...
            this.getScrollablePane().getChildren().add(panel);
            this.panels.put(Mail$$subject, panel);
        }catch(ModelException e){
            this.getExceptionAndEventhandler().handleException(e);
        }
        try{
            BaseTypePanel panel = new StringPanel(this, "text", this.getAnything().getText());
            this.getScrollablePane().getChildren().add(panel);
            this.panels.put(Mail$$text, panel);
        }catch(ModelException e){
            this.getExceptionAndEventhandler().handleException(e);
        }
        
    }
    protected view.DraftView getAnything(){
        return (view.DraftView)this.anything;
    }
}
...
class MailEntryDefaultDetailPanel extends DefaultDetailPanel{
    
    protected static final String Mail$$receivers = "Mail$$receivers";
    protected static final String Mail$$subject = "Mail$$subject";
    protected static final String Mail$$text = "Mail$$text";
    protected static final String MailEntry$$sender = "MailEntry$$sender";
    
    protected MailEntryDefaultDetailPanel(ExceptionAndEventHandler exceptionHandler, Anything anything) {
        super(exceptionHandler, anything);
    }
    protected void addFields(){
        try{
    ...
    protected view.MailEntryView getAnything(){
        return (view.MailEntryView)this.anything;
    }
}
